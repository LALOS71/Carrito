	...
	if sesion_caducada= "NO" then
		...
		while not rs_impresoras.eof
			...
			if rs_impresoras("ESTADO")="ACTIVA" OR rs_impresoras("ESTADO")="DEFECTUOSA" OR rs_impresoras("ESTADO")="AVERIADA" _
				OR rs_impresoras("ESTADO")="EN CESION" OR rs_impresoras("ESTADO")="SOLICITUD BAJA" OR rs_impresoras("ESTADO")="SOLICITUD DEFECTUOSA" _
				OR rs_impresoras("ESTADO")="SOLICITUD AVERIADA" OR rs_impresoras("ESTADO")="BAJA RECHAZADA" then
