		...
		*/
        ...
        if (typeof lst_devoluciones == 'undefined') {
            ...
            lst_devoluciones = j$('#lista_devoluciones').DataTable({dom:'<"toolbar">Blfrtip',
                                                          ajax:{url:'tojson/consulta_devoluciones_admin_obtener_devoluciones.asp?'+prm.toString(),
                                                           type:'POST',
                                                           dataSrc:'ROWSET'},
                                                     order:[],
													 columnDefs: [
			  ...
			  lst_devoluciones.ajax.url('tojson/consulta_devoluciones_admin_obtener_devoluciones.asp?' + prm.toString());
      ...
      var err ="";
        ...
        if (typeof lst_detalles_devolucion == 'undefined') {
            ...
            lst_detalles_devolucion = j$('#lista_detalles_devolucion').DataTable({dom:'<"toolbar">Blfrtip',
                                                          ajax:{url:'tojson/consulta_devoluciones_admin_obtener_detalles_devolucion.asp?p_id_devolucion=' + id_devolucion,
                                                           type:'POST',
                                                           dataSrc:'ROWSET'},
                                                     order:[],
													 columnDefs: [
			  ...
			  lst_detalles_devolucion.ajax.url('tojson/consulta_devoluciones_admin_obtener_detalles_devolucion.asp?p_id_devolucion=' + id_devolucion);
