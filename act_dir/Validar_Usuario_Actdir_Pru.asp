...
<%
	...
	response.write("<br>entrando en Validar_usuario_actdir")
	...
	response.write("<br>antes del cmd.execute")
	cmd.execute()
	response.write("<br>despues del cmd.execute")
	on error goto 0
	...
	response.write("<br>final del case para obtener el tipo de error de la conexion")
...
response.write("<br>final de Validar_usuario_actdir")
