...
<%
	...
	response.write("<br>entrando en  la validacion -- ")
	...
	response.write("<br>usuario form: " & usuario)
	response.write("<br>pass from: " & contrasenna)
	...
	response.write("<br>usuario final: " & usuario)
	response.write("<br>pass final: " & contrasenna)
