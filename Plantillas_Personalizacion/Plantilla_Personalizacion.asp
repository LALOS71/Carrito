...
////////////////////////////////////////////////////////////
			...
			var Plantilla_28 = function(cantidad_tarjetas, calle, numero_calle, poblacion, cp, provincia, email, telefono, email_pruebas){  
  			     this.cantidad_tarjetas = cantidad_tarjetas;  
       			 this.calle = calle;  
				 this.numero_calle = numero_calle;  
				 this.poblacion = poblacion;  
			...
			var Plantilla_29 = function(calle, numero_calle, poblacion, cp, telefono, email, cibal, email_pruebas){  
				 this.calle = calle;  
				 this.numero_calle = numero_calle;  
				 this.poblacion = poblacion;  
				 this.cp = cp;  
...
$(function(){
	...
	// Evento que selecciona la fila y la elimina en la plantilla_28
	$(document).on("click",".plantilla_28 .eliminar",function(){
		//var parent = $(this).parents().get(0);
		//$(parent).remove();
		var parent = $(this).parents().get(4)
		//para que desaparezca lentamente
	...
	// Evento borra los datos en la plantilla_29
	$(document).on("click",".plantilla_29 .eliminar",function(){
		$('.plantilla_29 .calle_tarjeta').val('')
		$('.plantilla_29 .numero_calle_tarjeta').val('')
		$('.plantilla_29 .poblacion_tarjeta').val('')
		$('.plantilla_29 .cp_tarjeta').val('')
		$('.plantilla_29 .telefono_tarjeta').val('')
		$('.plantilla_29 .email_agencia_tarjeta').val('')
		$('.plantilla_29 .cibal').val('')
		$('.plantilla_29 .email_prueba_tarjeta').val('')
		
		$('.plantilla_29 .requerir').closest("div").addClass("has-error")
		$('.plantilla_29 .requerir').siblings().addClass("text-danger")
	});
	...
	$("#guardar_plantillas").on("click", function(){
			...
			$(".plantilla_11 .email_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					...
					if ($(elemento).val()=='')
						...
						{
						<%'si desde GLS piden TARJETAS DE VISITA AGENCIAS (2440 o 3455), tienen que poner el mail corporativo @gls-spain.es
						if session("usuario_codigo_empresa")=4 and (codigo_articulo=2440 or codigo_articulo=3455) then%>
							if (($(elemento).val().toUpperCase().indexOf('@GLS-SPAIN.ES') == -1) && ($(elemento).val().toUpperCase().indexOf('@GLS-SPAIN.COM') == -1))
								{
								valor='Ha de introducir un Email Corporativo (xxxx@gls-spain.es o xxxx@gls-spain.com) en la Plantilla nº ' + indice + '.'
			...
			$(".plantilla_12 .email_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					...
					if ($(elemento).val()=='')
						...
						{
						<%'si desde GLS piden TARJETAS DE VISITA EMPLEADOS (2706 o 3456), tienen que poner el mail corporativo @gls-spain.es
						if session("usuario_codigo_empresa")=4 and (codigo_articulo=2706 or codigo_articulo=3456) then%>
							if (($(elemento).val().toUpperCase().indexOf('@GLS-SPAIN.ES') == -1) && ($(elemento).val().toUpperCase().indexOf('@GLS-SPAIN.COM') == -1))
								{
								valor='Ha de introducir un Email Corporativo (xxxx@gls-spain.es o xxxx@gls-spain.com) en la Plantilla nº ' + indice + '.'
								cadena_error=cadena_error + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- ' + valor + '<br>'
			...
			$(".plantilla_15 .email_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					...
					if ($(elemento).val()=='')
						...
						{
						<%'si desde GLS piden TARJETAS DE VISITA AGENCIAS (2745 o 3661), tienen que poner el mail corporativo @gls-spain.es
						if session("usuario_codigo_empresa")=4 and (codigo_articulo=2745 or codigo_articulo=3661) then%>
							if (($(elemento).val().toUpperCase().indexOf('@GLS-SPAIN.ES') == -1) && ($(elemento).val().toUpperCase().indexOf('@GLS-SPAIN.COM') == -1))
								{
								valor='Ha de introducir un Email Corporativo (xxxx@gls-spain.es o xxxx@gls-spain.com) en la Plantilla nº ' + indice + '.'
								cadena_error=cadena_error + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- ' + valor + '<br>'
		...
		//PLANTILLA_28		
		if ('<%=plantilla%>'=='plantilla_28')
			{
			$(".plantilla_28 .cantidad_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			/* los campos no nos obligatorios
			$(".plantilla_28 .calle_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			$(".plantilla_28 .numero_calle_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			$(".plantilla_28 .poblacion_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			$(".plantilla_28 .cp_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			*/
			...
			$(".plantilla_28 .email_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			/*
			$(".plantilla_28 .telefono_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			*/
			...
			$(".plantilla_28 .email_prueba_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
		...
		//PLANTILLA_29		
		if ('<%=plantilla%>'=='plantilla_29')
			{
			$(".plantilla_29 .calle_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			$(".plantilla_29 .numero_calle_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			$(".plantilla_29 .poblacion_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			$(".plantilla_29 .cp_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			$(".plantilla_29 .telefono_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			$(".plantilla_29 .email_agencia_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			$(".plantilla_29 .cibal").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
						cadena_error=cadena_error + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- <%=plantilla_personalizacion_error_cibal%><br>'
						hay_error='SI'
						} 
					}
			});
			...
			$(".plantilla_29 .email_prueba_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
		...
		if ('<%=plantilla%>'=='plantilla_30')
			{
			$(".plantilla_30 .ciudad_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			$(".plantilla_30 .email_tarjeta").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
...
function getFormJson(){ 
	...
	if ('<%=plantilla%>'=='plantilla_28')
		{
		var plan_cantidades  = $(".plantilla_28 .cantidad_tarjeta");  
		var plan_calles = $(".plantilla_28 .calle_tarjeta");  
		var plan_numeros_calles = $(".plantilla_28 .numero_calle_tarjeta");  
		var plan_poblaciones = $(".plantilla_28 .poblacion_tarjeta");  
		var plan_cps = $(".plantilla_28 .cp_tarjeta");  
		var plan_provincias = $(".plantilla_28 .provincia_tarjeta");  
		var plan_emails = $(".plantilla_28 .email_tarjeta");  
		var plan_telefonos = $(".plantilla_28 .telefono_tarjeta");  
		var plan_emails_pruebas = $(".plantilla_28 .email_prueba_tarjeta");  
		
		jQuery.each(plan_cantidades, function(pos, item){  
			if (pos>0)
			{
			pedidoObj.addPlantilla(new Plantilla_28(plan_cantidades[pos].value, 
							plan_calles[pos].value,
							plan_numeros_calles[pos].value,
							plan_poblaciones[pos].value,
							plan_cps[pos].value,
	...
	if ('<%=plantilla%>'=='plantilla_29')
		{
		var plan_calle = $(".plantilla_29 .calle_tarjeta");  
		var plan_numero_calle = $(".plantilla_29 .numero_calle_tarjeta");  
		var plan_poblacion = $(".plantilla_29 .poblacion_tarjeta");  
		var plan_cp = $(".plantilla_29 .cp_tarjeta");  
		var plan_telefono = $(".plantilla_29 .telefono_tarjeta");  
		var plan_email = $(".plantilla_29 .email_agencia_tarjeta");  
		var plan_cibal = $(".plantilla_29 .cibal");  
		var plan_emails_pruebas = $(".plantilla_29 .email_prueba_tarjeta");  
		
		jQuery.each(plan_calle, function(pos, item){  
			if (pos>0)
			{
			pedidoObj.addPlantilla(new Plantilla_29(plan_calle[pos].value,
							plan_numero_calle[pos].value,
							plan_poblacion[pos].value,
							plan_cp[pos].value,
							plan_telefono[pos].value,
							plan_email[pos].value,
							plan_cibal[pos].value,
							plan_emails_pruebas[pos].value
							));  
			}
		});  
	...
	if ('<%=plantilla%>'=='plantilla_30')
		{
		var plan_ciudad = $(".plantilla_30 .ciudad_tarjeta");  
		var plan_email = $(".plantilla_30 .email_tarjeta");  
		
		jQuery.each(plan_ciudad, function(pos, item){  
			if (pos>0)
			{
			pedidoObj.addPlantilla(new Plantilla_30(plan_ciudad[pos].value,
							plan_email[pos].value
							));  
			}
		});  
				...
				$.getJSON(ruta_fichero_json, function(plantillas) {
						...
						for (x in plantillas.plantillas)
							...
							if ('<%=plantilla%>'=='plantilla_28')
								...
								if (indice_plantillas!=1)
									{
									$("#contenedor_plantillas .plantilla_28:first").clone().appendTo("#contenedor_plantillas").hide().fadeIn('slow');
									}
								
								$('.plantilla_28 .cantidad_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].cantidad_tarjetas)
								$('.plantilla_28 .calle_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].calle)
								$('.plantilla_28 .numero_calle_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].numero_calle)
								$('.plantilla_28 .poblacion_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].poblacion)
								$('.plantilla_28 .cp_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].cp)
								$('.plantilla_28 .provincia_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].provincia)
								$('.plantilla_28 .email_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].email)
								$('.plantilla_28 .telefono_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].telefono)
								$('.plantilla_28 .email_prueba_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].email_pruebas)
								}
							...
							if ('<%=plantilla%>'=='plantilla_29')
								...
								if (indice_plantillas!=1)
									{
									$("#contenedor_plantillas .plantilla_29:first").clone().appendTo("#contenedor_plantillas").hide().fadeIn('slow');
									}
								
								$('.plantilla_29 .calle_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].calle)
								$('.plantilla_29 .numero_calle_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].numero_calle)
								$('.plantilla_29 .poblacion_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].poblacion)
								$('.plantilla_29 .cp_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].cp)
								$('.plantilla_29 .telefono_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].telefono)
								$('.plantilla_29 .email_agencia_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].email)
								$('.plantilla_29 .cibal:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].cibal)
								$('.plantilla_29 .email_prueba_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].email_pruebas)
								}
...
<div class="container-fluid" id="contenedor_plantillas" name="contenedor_plantillas">
	...
	<div class="plantilla_28" style="display:none">
		<div class="panel panel-default">
  			<div class="panel-body">
				<div class="row form-group form-group-sm">
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 has-error">
					...
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
						<%=plantilla_personalizacion_calle%>:
						<input type="text" class="form-control calle_tarjeta">
					</div>
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
						<%=plantilla_personalizacion_numero%>:
						<input type="text" class="form-control numero_calle_tarjeta">
					</div>
				</div>
				<div class="row form-group form-group-sm">
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
						<%=plantilla_personalizacion_poblacion%>:
						<input type="text" class="form-control poblacion_tarjeta">
					</div>
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
						<%=plantilla_personalizacion_cp%>:
						<input type="text" class="form-control cp_tarjeta">
					</div>
					<div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
						<%=plantilla_personalizacion_provincia%>:
						<input type="text" class="form-control provincia_tarjeta">
				...
				<div class="row form-group form-group-sm">
					...
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
						<%=plantilla_personalizacion_email_envio%>:
						<input type="text" class="form-control email_prueba_tarjeta">
					</div>
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
						<br />
						<button type="button" class="btn btn-block btn-md eliminar" id="" name="">
	...
	<div class="plantilla_29" style="display:none">
		<div class="panel panel-default">
  			<div class="panel-body">
				<div class="row">
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 has-error">
				...
				<div class="row">
					...
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 has-error">
						<span class="text-danger"><%=plantilla_personalizacion_cibal%>:</span>
						<input type="text" class="form-control cibal requerir">
					</div>
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					</div>
				</div>
	...
	<div class="plantilla_30" style="display:none">
		<div class="panel panel-default">
  			<div class="panel-body">
				<div class="row">
					<div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 has-error">
...
<div class="container-fluid" id="botones">
	<div class="row">
		...
		<%if modo<>"CONSULTAR" then%>
			<%if plantilla="plantilla_1" or plantilla="plantilla_11" or plantilla="plantilla_12" or plantilla="plantilla_15" or plantilla="plantilla_28" then%>
				<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
