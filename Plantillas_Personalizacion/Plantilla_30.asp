...
<%
	...
	'response.write("<br>variable sesion session('json_" & codigo_articulo & "'): " & texto_json)
	  ...
	  else //del if texto_json!=''
	  	{
			...
			if (modo=='CONSULTAR')
				...
				$.getJSON(ruta_fichero_json, function(plantillas) {
						...
						//console.log('datataaa.plantillas.ciudad: ' + plantillas.plantillas[0].ciudad)
					...
					$(".plantilla_30 .requerir").closest("div").removeClass("has-error")
					$(".plantilla_30 .requerir").siblings().removeClass("text-danger")										
