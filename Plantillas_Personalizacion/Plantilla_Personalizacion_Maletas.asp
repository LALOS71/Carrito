				...
				<div class="col-sm-12 col-md-12 col-lg-12">
					<div class="form-group row">
						...
						<div class="col-sm-2 col-md-2 col-lg-2">
							...
							<input type="text" class="form-control texto" style="width: 100%;"  id="txthorario_entrega_d" name="txthorario_entrega_d" value="" maxlength="50" />
						</div>
					...
					<div class="col-sm-12 col-md-12 col-lg-12">
                    	<div class="form-group row vertical-align">
							<div class="col-sm-1 col-md-1 col-lg-1">
								...
								<select class="form-control" id="cmbnif_otros" name="cmbnif_otros" style="width: 100%;">
		...
		window.parent.$("#pantalla_avisos").modal("show");
	  ...
	  else
	  	{
			...
			if ($('#radio1').is(':checked'))
				{
				//console.log('ANTES DE OCULTAR LA FILA DE GASTOS DE ENVIO')
				window.parent.$("#fila_gastos_envio").hide()
				
				window.parent.$("#ocultogastos_envio_pedido").val(0)
				window.parent.$("#ocultogastos_envio_pedido_mostrar").val(0)
				//console.log('antes de recalcular gastos de envio - ENVIO DESDE LA OFICINA')
				//console.log('gastos de envio: ' + window.parent.$("#ocultogastos_envio_pedido").val())
				
				window.parent.recalcular_gastos_envio()
				//console.log('antes de recalcular TOTALES - ENVIO DESDE LA OFICINA')
				//console.log('gastos de envio: ' + window.parent.$("#ocultogastos_envio_pedido").val())
				window.parent.recalcular_totales()
				//console.log('despues de recalcular TOTALES - ENVIO DESDE LA OFICINA')
				//console.log('gastos de envio: ' + window.parent.$("#ocultogastos_envio_pedido").val())
				}
			  else
			  	{
				//console.log('ANTES DE MOSTRAR LA FILA DE GASTOS DE ENVIO')
				window.parent.$("#fila_gastos_envio").show()
				
				//console.log('antes de recalcular totales')
				//console.log('antes de recalcular gastos de envio - ENVIO DESDE OTRO SITIO')
				window.parent.recalcular_gastos_envio()
				//console.log('antes de recalcular TOTALES - ENVIO DESDE OTRO SITIO')
				window.parent.recalcular_totales()
