				...
				$.getJSON(ruta_fichero_json, function(plantillas) {
						...
						for (x in plantillas.plantillas)
							...
							if ('<%=plantilla%>'=='plantilla_16')
								...
								if (indice_plantillas!=1)
									{
									//$("#tabla tbody .plantilla_1").clone().removeClass('plantilla_1').appendTo("#body_principal").hide().fadeIn('slow');
									$("#tabla tbody .plantilla_16:first").clone().appendTo("#body_principal").hide().fadeIn('slow');
									}
							...
							if ('<%=plantilla%>'=='plantilla_17')
								...
								if (indice_plantillas!=1)
									{
									//$("#tabla tbody .plantilla_1").clone().removeClass('plantilla_1').appendTo("#body_principal").hide().fadeIn('slow');
									$("#tabla tbody .plantilla_17:first").clone().appendTo("#body_principal").hide().fadeIn('slow');
									}
							...
							if ('<%=plantilla%>'=='plantilla_18')
								...
								if (indice_plantillas!=1)
									{
									//$("#tabla tbody .plantilla_1").clone().removeClass('plantilla_1').appendTo("#body_principal").hide().fadeIn('slow');
									$("#tabla tbody .plantilla_18:first").clone().appendTo("#body_principal").hide().fadeIn('slow');
									}
							...
							if ('<%=plantilla%>'=='plantilla_19')
								...
								if (indice_plantillas!=1)
									{
									//$("#tabla tbody .plantilla_1").clone().removeClass('plantilla_1').appendTo("#body_principal").hide().fadeIn('slow');
									$("#tabla tbody .plantilla_19:first").clone().appendTo("#body_principal").hide().fadeIn('slow');
									}
						...
						if ('<%=plantilla%>'=='plantilla_20')
								...
								if (indice_plantillas!=1)
									{
									//$("#tabla tbody .plantilla_1").clone().removeClass('plantilla_1').appendTo("#body_principal").hide().fadeIn('slow');
									$("#tabla tbody .plantilla_20:first").clone().appendTo("#body_principal").hide().fadeIn('slow');
									}
...
<table id="tabla">
	...
	<tbody id="body_principal">
		...
		<tr class="plantilla_16" style="display:none">
			<td>
				<table width="626" id="tabla_elemento">
					<tr>
						<td colspan="2" class="obligatorio texto_celda">&nbsp;<%=plantilla_personalizacion_calle%></td>
					...
					<tr>
						<td colspan="2" class="obligatorio texto_celda">&nbsp;<%=plantilla_personalizacion_telefono%></td>
						<td colspan="2" class="obligatorio texto_celda">&nbsp;<%=plantilla_personalizacion_email_envio%></td>
						<td>&nbsp;</td>
						<td rowspan="2" align="center" class="eliminar texto_celda boton_celda "><%=plantilla_personalizacion_boton_eliminar%></td>
					</tr>
					<tr>
						<td colspan="2"><input type="text" class="telefono_tarjeta" size="14" /></td>
						<td colspan="2"><input type="text" class="email_prueba_tarjeta" size="35" /></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
		...
		<tr class="plantilla_17" style="display:none">
			<td>
				<table width="626" id="tabla_elemento">
					<tr>
						<td colspan="2" class="obligatorio texto_celda">&nbsp;<%=plantilla_personalizacion_calle%></td>
					...
					<tr>
						<td class="obligatorio texto_celda">&nbsp;<%=plantilla_personalizacion_telefono%></td>
						<td colspan="2" class="obligatorio texto_celda">&nbsp;<%=plantilla_personalizacion_email%></td>
						<td colspan="2" class="obligatorio texto_celda">&nbsp;<%=plantilla_personalizacion_email_envio%></td>
						<td rowspan="2" align="center" class="eliminar texto_celda boton_celda "><%=plantilla_personalizacion_boton_eliminar%></td>
					</tr>
					<tr>
						<td><input type="text" class="telefono_tarjeta" size="14" /></td>
						<td colspan="2"><input type="text" class="email_agencia_tarjeta" size="35" /></td>
						<td colspan="2"><input type="text" class="email_prueba_tarjeta" size="35" /></td>
					</tr>
					<tr>
						<td colspan="2"  class="texto_celda"><div class="obligatorio texto_celda" style="height:12px;width:20px;float:left"></div>&nbsp;<%=plantilla_personalizacion_campos_obligatorios%></td>
		...
		<tr class="plantilla_18" style="display:none">
			<td>
				<table width="626" id="tabla_elemento">
					<tr>
						<td colspan="2" class="obligatorio texto_celda">&nbsp;<%=plantilla_personalizacion_razon_social%></td>
					...
					<tr>
						<td colspan="2" class="obligatorio texto_celda">&nbsp;Domicilio Social</td>
						<td width="120" class="obligatorio texto_celda">&nbsp;<%=plantilla_personalizacion_numero%></td>
						<td colspan="2" class="obligatorio texto_celda">&nbsp;Localidad</td>
						<td class="obligatorio texto_celda">&nbsp;<%=plantilla_personalizacion_cp%></td>
					</tr>
					<tr>
						<td colspan="2"><input type="text" class="calle_tarjeta" size="35" /></td>
					...
					<tr>
						<td colspan="2" class="texto_celda borde_celda">&nbsp;<%=plantilla_personalizacion_horario_lu_vi%></td>
						<td colspan="2" class="texto_celda borde_celda">&nbsp;<%=plantilla_personalizacion_horario_sabados%></td>
						<td>&nbsp;</td>
						<td rowspan="2" align="center" class="eliminar texto_celda boton_celda "><%=plantilla_personalizacion_boton_eliminar%></td>
		...
		<tr class="plantilla_19" style="display:none">
			<td>
				<table width="626" id="tabla_elemento">
					<tr>
						<td colspan="2" class="obligatorio texto_celda">&nbsp;<%=plantilla_personalizacion_razon_social%></td>
						<td width="120" class="obligatorio texto_celda">&nbsp;CIF</td>
						<td colspan="2" class="obligatorio texto_celda">&nbsp;<%=plantilla_personalizacion_email_envio%></td>
						<td rowspan="2" align="center" class="eliminar texto_celda boton_celda "><%=plantilla_personalizacion_boton_eliminar%></td>
					...
					<tr>
						<td colspan="2"><input type="text" class="razon_social_tarjeta" size="35" /></td>
						<td><input type="text" class="cif_tarjeta" size="18" /></td>
						<td colspan="2" ><input type="text" class="email_prueba_tarjeta" size="35" /></td>
		...
		<tr class="plantilla_20" style="display:none">
			<td>
				<table width="626" id="tabla_elemento">
					<tr>
						<td colspan="2" class="obligatorio texto_celda">&nbsp;Nombre Grupo</td>
						<td colspan="3" class="obligatorio texto_celda">&nbsp;Expediente</td>
						<td rowspan="2" align="center" class="eliminar texto_celda boton_celda "><%=plantilla_personalizacion_boton_eliminar%></td>
					</tr>
					<tr>
						<td colspan="2"><input type="text" class="nombre_grupo_tarjeta" size="45" /></td>
						<td colspan="3" ><input type="text" class="expediente_tarjeta" size="35" /></td>
					</tr>
					<tr>
						<td colspan="2" class="obligatorio texto_celda">&nbsp;Total Venta Expediente</td>
						<td colspan="2" class="obligatorio texto_celda">&nbsp;Total Coste Expediente</td>
						<td colspan="2" class="obligatorio texto_celda">&nbsp;Beneficio</td>
					</tr>
					<tr>
						<td colspan="2"><input type="text" class="total_venta_expediente_tarjeta" size="35" /></td>
						<td colspan="2"><input type="text" class="total_coste_expediente_tarjeta" size="35"/></td>
						<td colspan="2"><input type="text" class="beneficio_tarjeta" size="35"/></td>
					</tr>
