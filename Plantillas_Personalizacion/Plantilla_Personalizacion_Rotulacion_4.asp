...
<%
	...
	campos=Request.QueryString("campos")
	...
	'response.write("<br>campos: " & campos)
	campos_rotulacion=split(campos, "$")
...
////////////////////////////////////////////////////////////
			...
			var Plantilla_Rotulacion_4 = function(campo1, descripcion1, campo2, descripcion2, campo3, descripcion3, campo4, descripcion4, email_pruebas){  
				 this.campo1 = campo1;  
...
$(function(){
	...
	$(document).on("click",".plantilla_rotulacion_4 .eliminar",function(){
		
		$('.plantilla_rotulacion_4 .descripcion1').val('')
		$('.plantilla_rotulacion_4 .descripcion2').val('')
		$('.plantilla_rotulacion_4 .descripcion3').val('')
		$('.plantilla_rotulacion_4 .descripcion4').val('')
		$('.plantilla_rotulacion_4 .email_pruebas').val('')
		
		$('.plantilla_rotulacion_4 .requerir').closest("div").addClass("has-error")
		$('.plantilla_rotulacion_4 .requerir').siblings().addClass("text-danger")
	});
	...
	$("#guardar_plantillas").on("click", function(){
		...
		//PLANTILLA_1		
		if ('<%=plantilla%>'=='plantilla_rotulacion_4')
			{
			$(".plantilla_rotulacion_4 .descripcion1").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
						cadena_error=cadena_error + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Todos los Datos Son Obligatorios.<br>'
						hay_error='SI'
						} 
					}
			});
			$(".plantilla_rotulacion_4 .descripcion2").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			$(".plantilla_rotulacion_4 .descripcion3").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			$(".plantilla_rotulacion_4 .descripcion4").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			$(".plantilla_rotulacion_4 .email_pruebas").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
...
function getFormJson(){ 
	...
	if ('<%=plantilla%>'=='plantilla_rotulacion_4')
		{
		var plan_campo1 = $(".plantilla_rotulacion_4 .campo1");  
		var plan_descripcion1 = $(".plantilla_rotulacion_4 .descripcion1");  
		var plan_campo2 = $(".plantilla_rotulacion_4 .campo2");  
		var plan_descripcion2 = $(".plantilla_rotulacion_4 .descripcion2");  
		var plan_campo3 = $(".plantilla_rotulacion_4 .campo3");  
		var plan_descripcion3 = $(".plantilla_rotulacion_4 .descripcion3");  
		var plan_campo4 = $(".plantilla_rotulacion_4 .campo4");  
		var plan_descripcion4 = $(".plantilla_rotulacion_4 .descripcion4");  
		var plan_email_pruebas = $(".plantilla_rotulacion_4 .email_pruebas");  
		
		jQuery.each(plan_descripcion1, function(pos, item){  
			if (pos>0)
			{
			pedidoObj.addPlantilla(new Plantilla_Rotulacion_4(plan_campo1[pos].value, plan_descripcion1[pos].value, plan_campo2[pos].value, plan_descripcion2[pos].value, plan_campo3[pos].value, plan_descripcion3[pos].value, plan_campo4[pos].value, plan_descripcion4[pos].value, plan_email_pruebas[pos].value));  
			}
		});  
		}
						...
						for (x in plantillas.plantillas)
							...
							if ('<%=plantilla%>'=='plantilla_rotulacion_4')
								...
								if (indice_plantillas!=1)
									{
									$("#contenedor_plantillas .plantilla_rotulacion_4:first").clone().appendTo("#contenedor_plantillas").hide().fadeIn('slow');
									}
								
								$('.plantilla_rotulacion_4 .descripcion1:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].descripcion1)
								$('.plantilla_rotulacion_4 .descripcion2:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].descripcion2)
								$('.plantilla_rotulacion_4 .descripcion3:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].descripcion3)
								$('.plantilla_rotulacion_4 .descripcion4:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].descripcion4)
								$('.plantilla_rotulacion_4 .email_pruebas:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].email_pruebas)
								}
							indice_plantillas++
							}				
...
<div class="container-fluid" id="contenedor_plantillas" name="contenedor_plantillas">
	...
	<div class="plantilla_rotulacion_4" style="display:none">
		<div class="panel panel-default">
  			<div class="panel-body">
				<div class="row">
					<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 has-error">
						<span class="text-danger"><%=campos_rotulacion(0)%>:</span>
						<input type="hidden" class="campo1" value="<%=campos_rotulacion(0)%>" />
						<input type="text" class="form-control descripcion1 requerir">
					</div>
				</div>
				<div class="row">
					<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 has-error">
						<span class="text-danger"><%=campos_rotulacion(1)%>:</span>
						<input type="hidden" class="campo2" value="<%=campos_rotulacion(1)%>" />
						<input type="text" class="form-control descripcion2 requerir">
					</div>
				</div>
				<div class="row">
					<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 has-error">
						<span class="text-danger"><%=campos_rotulacion(2)%>:</span>
						<input type="hidden" class="campo3" value="<%=campos_rotulacion(2)%>" />
						<input type="text" class="form-control descripcion3 requerir">
					</div>
				</div>
				<div class="row">
					<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 has-error">
						<span class="text-danger"><%=campos_rotulacion(3)%>:</span>
						<input type="hidden" class="campo4" value="<%=campos_rotulacion(3)%>" />
						<input type="text" class="form-control descripcion4 requerir">
					</div>
					
				</div>
				<div class="row">
					<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 has-error">
						<span class="text-danger">Email Pruebas:</span>
						<input type="text" class="form-control email_pruebas requerir">
					</div>
	...
	</div><!--fin plantilla_rotulacion_4-->	
