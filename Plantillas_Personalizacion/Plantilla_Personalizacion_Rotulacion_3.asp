...
////////////////////////////////////////////////////////////
			...
			var Plantilla_Rotulacion_3 = function(campo1, descripcion1, campo2, descripcion2, campo3, descripcion3, email_pruebas){  
				 this.campo1 = campo1;  
...
$(function(){
	...
	$(document).on("click",".plantilla_rotulacion_3 .eliminar",function(){
		
		$('.plantilla_rotulacion_3 .descripcion1').val('')
		$('.plantilla_rotulacion_3 .descripcion2').val('')
		$('.plantilla_rotulacion_3 .descripcion3').val('')
		$('.plantilla_rotulacion_3 .email_pruebas').val('')
		
		$('.plantilla_rotulacion_3 .requerir').closest("div").addClass("has-error")
		$('.plantilla_rotulacion_3 .requerir').siblings().addClass("text-danger")
	});
	...
	$("#guardar_plantillas").on("click", function(){
		...
		//PLANTILLA_1		
		if ('<%=plantilla%>'=='plantilla_rotulacion_3')
			{
			$(".plantilla_rotulacion_3 .descripcion1").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			$(".plantilla_rotulacion_3 .descripcion2").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			$(".plantilla_rotulacion_3 .descripcion3").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
			...
			$(".plantilla_rotulacion_3 .email_pruebas").each(function(indice, elemento) {
				if (indice!=0)
					{
					if ($(elemento).val()=='')
						{
...
function getFormJson(){ 
	...
	if ('<%=plantilla%>'=='plantilla_rotulacion_3')
		{
		var plan_campo1 = $(".plantilla_rotulacion_3 .campo1");  
		var plan_descripcion1 = $(".plantilla_rotulacion_3 .descripcion1");  
		var plan_campo2 = $(".plantilla_rotulacion_3 .campo2");  
		var plan_descripcion2 = $(".plantilla_rotulacion_3 .descripcion2");  
		var plan_campo3 = $(".plantilla_rotulacion_3 .campo3");  
		var plan_descripcion3 = $(".plantilla_rotulacion_3 .descripcion3");  
		var plan_email_pruebas = $(".plantilla_rotulacion_3 .email_pruebas");  
		
		jQuery.each(plan_descripcion1, function(pos, item){  
			if (pos>0)
			{
			pedidoObj.addPlantilla(new Plantilla_Rotulacion_3(plan_campo1[pos].value, plan_descripcion1[pos].value, plan_campo2[pos].value, plan_descripcion2[pos].value, plan_campo3[pos].value, plan_descripcion3[pos].value, plan_email_pruebas[pos].value));  
			}
		});  
		}
						...
						for (x in plantillas.plantillas)
							...
							if ('<%=plantilla%>'=='plantilla_rotulacion_3')
								...
								if (indice_plantillas!=1)
									{
									$("#contenedor_plantillas .plantilla_rotulacion_3:first").clone().appendTo("#contenedor_plantillas").hide().fadeIn('slow');
									}
								
								$('.plantilla_rotulacion_3 .descripcion1:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].descripcion1)
								$('.plantilla_rotulacion_3 .descripcion2:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].descripcion2)
								$('.plantilla_rotulacion_3 .descripcion3:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].descripcion3)
								$('.plantilla_rotulacion_3 .email_pruebas:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].email_pruebas)
								}
							indice_plantillas++
							}				
...
<div class="container-fluid" id="contenedor_plantillas" name="contenedor_plantillas">
	...
	<div class="plantilla_rotulacion_3" style="display:none">
	...
	</div><!--fin plantilla_rotulacion_3-->	
