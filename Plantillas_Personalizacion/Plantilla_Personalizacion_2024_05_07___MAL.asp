...
////////////////////////////////////////////////////////////
			...
			var Plantilla_29 = function(calle, numero_calle, poblacion, cp, telefono, email_agencia, email_pruebas, cibal){  
				 this.calle = calle;  
				 this.numero_calle = numero_calle;  
				 this.poblacion = poblacion;  
				 this.cp = cp;  
...
$(function(){
	...
	$("#guardar_plantillas").on("click", function(){
		...
		console.log('antes de comprobaciones especiales')
		...
		console.log('antes de comprobar si hay errores')
...
function getFormJson(){ 
	...
	if ('<%=plantilla%>'=='plantilla_29')
		{
		var plan_calles = $(".plantilla_29 .calle_tarjeta");  
		var plan_numeros_calles = $(".plantilla_29 .numero_calle_tarjeta");  
		var plan_poblaciones = $(".plantilla_29 .poblacion_tarjeta");  
		var plan_cps = $(".plantilla_29 .cp_tarjeta");  
		var plan_telefonos = $(".plantilla_29 .telefono_tarjeta");  
		var plan_emails_agencias = $(".plantilla_29 .email_agencia_tarjeta");  
		...
		jQuery.each(plan_telefonos, function(pos, item){  
			if (pos>0)
			{
			pedidoObj.addPlantilla(new Plantilla_29(plan_calles[pos].value,
							plan_numeros_calles[pos].value,
							plan_poblaciones[pos].value,
							plan_cps[pos].value,
							plan_telefonos[pos].value,
				...
				$.getJSON(ruta_fichero_json, function(plantillas) {
						...
						for (x in plantillas.plantillas)
							...
							if ('<%=plantilla%>'=='plantilla_29')
								...
								$('.plantilla_29 .email_agencia_tarjeta:eq(' + indice_plantillas + ')').val(plantillas.plantillas[x].email_agencia)
