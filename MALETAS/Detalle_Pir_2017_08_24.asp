...
j$('#cmdguardar_pir').on('click', function() {
	...
	if (j$("#ocultoid_pir").val()=='')
		...
		if (j$("#txtfecha_pir_d").val()=='')
			{
			hay_error=hay_error + '- Al Dar De Alta El PIR, Ha de Introducir la Fecha del PIR.<br>'
			}
		...
		if (j$("#txttag_d").val()=='')
			{
			hay_error=hay_error + '- Al Dar De Alta El PIR, Ha de Introducir el TAG.<br>'
			}
				
		if (j$("#txtruta_d").val()=='')
			{
			hay_error=hay_error + '- Al Dar De Alta El PIR, Ha de Introducir la Ruta.<br>'
			}

		if (j$("#txtvuelos_d").val()=='')
			{
			hay_error=hay_error + '- Al Dar De Alta El PIR, Ha de Introducir los Vuelos.<br>'
			}
		}
