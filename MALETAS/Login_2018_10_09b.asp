...
/*		
		if (encontrado==-1)
			...
			j$("#body_avisos").html('<br><h4>Este Usuario no Está Dado de Alta para Poder Utilizar Esta Aplicación</h4><br>');
		  ...
		  else //ha encontrado el usuario, lo valida en el active directori
		  	{
			validando()
			}
*/
