		...
		<div class="panel panel-info">
			...
			<div id="desplegable" class=" panel-body panel-collapse collapse " role="tabpanel" aria-labelledby="heading01">
				<form action="" method="post" novalidate="novalidate">
					<input type="hidden" id="ocultoperfil" name="ocultoperfil" value="<%=session("perfil_usuario")%>" />
...
consultar_pirs = function(perfil) {  
	...
	columnas_a_exportar_cia='0,1,2,5,6,7,8,9,10,11,15,16,17,18,19,20,21,22'
	columnas_a_exportar_proveedor='0,2,8,24,25,26,27,28,29,1,6,7,30,5,11,23,9'
      ...
      var err ="";
		...
		*/
		...
		prm.add("p_ocultoperfil", j$('#ocultoperfil').val());
