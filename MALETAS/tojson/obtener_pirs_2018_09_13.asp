...
<%
	...
	'response.write("<br>nombre establecimiento: " & nombre_establecimiento)
		cadena_sql="SELECT PIRS.ID, PIRS.FECHA_ORDEN, PIRS.FECHA_INICIO, PIRS.PIR, PIRS.TIPO_BAG_ENTREGADA, PIRS.FECHA_ENVIO," 
		...
		cadena_sql=cadena_sql & " PIRS.FECHA_PIR, PIRS.TAG, PIRS.TIPO_EQUIPAJE_BAG_ORIGINAL, PIRS.MARCA_BAG_ORIGINAL,"
		cadena_sql=cadena_sql & " PIRS.RUTA, PIRS.VUELOS, PIRS.TIPO_BAG_ENTREGADA, PIRS.TAMANNO_BAG_ENTREGADA,"
