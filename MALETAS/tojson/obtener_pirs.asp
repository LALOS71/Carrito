...
<%
	...
	'response.write("<br>nombre establecimiento: " & nombre_establecimiento)
		...
		cadena_sql=cadena_sql & " PIRS.FECHA_PIR, PIRS.TAG, REPLACE(PIRS.TIPO_EQUIPAJE_BAG_ORIGINAL, '""','##Ç$$') AS TIPO_EQUIPAJE_BAG_ORIGINAL,"
		'cadena_sql=cadena_sql & " PIRS.FECHA_PIR, PIRS.TAG, PIRS.TIPO_EQUIPAJE_BAG_ORIGINAL,"		
		'cadena_sql=cadena_sql & " REPLACE(PIRS.MARCA_BAG_ORIGINAL,'""', '\""') AS MARCA_BAG_ORIGINAL,"
		cadena_sql=cadena_sql & " REPLACE(PIRS.MARCA_BAG_ORIGINAL,'""', '##Ç$$') AS MARCA_BAG_ORIGINAL,"
		'cadena_sql=cadena_sql & " PIRS.MARCA_BAG_ORIGINAL,"
		cadena_sql=cadena_sql & " PIRS.RUTA, PIRS.VUELOS, REPLACE(PIRS.TAMANNO_BAG_ENTREGADA,'""','##Ç$$') AS TAMANNO_BAG_ENTREGADA,"
		'cadena_sql=cadena_sql & " PIRS.RUTA, PIRS.VUELOS, PIRS.TAMANNO_BAG_ENTREGADA,"
		cadena_sql=cadena_sql & " PIRS.COLOR_BAG_ENTREGADA, PIRS.OBSERVACIONES_PROVEEDOR"
		'cadena_sql=cadena_sql & ", PIRS.NOMBRE, PIRS.APELLIDOS, PIRS.DIRECCION_ENTREGA"
		cadena_sql=cadena_sql & ", PIRS.NOMBRE, PIRS.APELLIDOS, REPLACE(PIRS.DIRECCION_ENTREGA, '""', '##Ç$$') AS DIRECCION_ENTREGA"
		
		cadena_sql=cadena_sql & " , PIRS.CP_ENTREGA, PIRS.MOVIL, PIRS.FIJO, PIRS.REFERENCIA_BAG_ENTREGADA"
		cadena_sql=cadena_sql & " ,(SELECT DESCRIPCION FROM TIPOS_MALETA WHERE CODIGO=PIRS.TIPO_BAG_ORIGINAL) AS TIPO_BAG_ORIGINAL"
	...
	'las comillas dobles se escapan con \"
	cadena_pirs=REPLACE(cadena_pirs,"##Ç$$", "\""")
