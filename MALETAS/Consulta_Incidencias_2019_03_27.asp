													 			...
													 			{orderable:false,
																	//orderDataType: "dom-checkbox",
                                                                       data:function(row, type, val, meta) { 
                                                                         return '<i style="cursor:pointer" onclick="chkOnClick(this)" class="state-icon fa fa-square-o fa-lg"'
																		 			+ ' data-toggle="popover_datatable"'
																					+ ' data-placement="right"'
																					+ ' data-trigger="hover"'
    ...
    */                                               
                ...
                */                                                               
				j$("#lista_pirs").on("xhr.dt", function(e, settings, json, xhr) {
					var str="";
					str = '<a href="#" class="btn btn-primary" onclick="mostrar_facturacion_en_bloque()" title="Crear Servicio"><i class="fa fa-files-o fa-lg" aria-hidden="true"></i>&nbsp;&nbsp;Fracturar En Bloque</a>';
