					  ...
					  <thead>
						<tr>
							<th style="text-align:center;" width="2%" align="center">
								<i id="checkAll" name="checkAll" style="cursor:pointer;" onclick="chkAllOnClick(this)" class="state-icon fa fa-square-o fa-lg"
...
consultar_pirs = function(perfil) {  
	...
	columnas_a_exportar_cia='0,1,2,5,6,7,8,9,10,11,15,16,17,18,19,20,21,22,31'
	columnas_a_exportar_proveedor='0,2,8,24,25,26,27,28,29,1,6,7,30,5,11,23,9,31,32,33,34'
													 			...
													 			{orderable:false,
																	//orderDataType: "dom-checkbox",
                                                                       data:function(row, type, val, meta) { 
                                                                         return '<i style="cursor:pointer" onclick="chkOnClick(this, ' + row.ID + ')" class="state-icon state-icon fa fa-square-o fa-lg"'
																		 			+ ' data-toggle="popover_datatable"'
																					+ ' data-placement="right"'
																					+ ' data-trigger="hover"'
    ...
    */                                               
				...
				//console.log('antes de ocultar columna')
			   	if (perfil=='PROVEEDOR')
					...
					lst_pirs.columns(10).visible(false)
					}
