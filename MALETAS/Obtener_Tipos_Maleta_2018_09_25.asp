...
<%
	Response.CharSet = "iso-8859-1"
			...
			with tipos_maleta
				...
				.Source="SELECT ID, CODIGO, DESCRIPCION, ORDEN"
											...
											<th>
													...
													<%if vacio_tipos_maleta=false then%>
														<script language="javascript">
															...
															j$("#tabla_tipos_maleta").find('.btn_add').hide();
														</script>
													<%end if%>
											</th>
										</tr>
...
j$(document).on('click', '.btn_add', function(event) 
	{
		...
		cadena = cadena + '<i class="fas fa-pencil-alt fa-lg btn_edit" row_id="fila_tipos_maleta_0" style="color:blue"'
		cadena = cadena + 'data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Editar el Tipo de Maleta"></i>&nbsp;'
		cadena = cadena + '<i class="fas fa-save fa-lg btn_save" row_id="fila_tipos_maleta_0" style="color:darkblue;display:none"'
		cadena = cadena + 'data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Guardar El Tipo de Maleta"></i>&nbsp;'
		cadena = cadena + '<i class="fas fa-times fa-lg btn_cancel" row_id="fila_tipos_maleta_0" style="color:red;display:none"'
		cadena = cadena + 'data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Cancelar"></i>&nbsp;'
		cadena = cadena + '<i class="fas fa-trash-alt fa-lg btn_delete" row_id="fila_tipos_maleta_0" style="color:darkred;display:none"'
...
mantenimiento_cantidades_precios = function(valor_accion, valor_id, valor_codigo_articulo, valor_cantidad, valor_precio_unidad, valor_precio_pack, valor_tipo_sucursal, valor_codigo_empresa) {
	/*
	j$.ajax({
		type: "post",        
...
j$(document).on('click', '.btn_add_tipos_maleta', function(event) 
	{
		//console.log('dentro del click de btn_add_tipos_maleta')
		event.preventDefault();
		...
		cadena = cadena + '<td>'
		cadena = cadena + '<div style="text-align:center">'
		cadena = cadena + '<i class="fas fa-pencil-alt fa-lg btn_edit" row_id="fila_tipos_maleta_x" style="color:blue;cursor:hand;cursor:pointer"'
		cadena = cadena + 'data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Editar el Tipo de Maleta"></i>&nbsp;'
		cadena = cadena + '<i class="fas fa-save fa-lg btn_save" row_id="fila_tipos_maleta_x" style="color:darkblue;display:none;cursor:hand;cursor:pointer"'
		cadena = cadena + 'data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Guardar El Tipo de Maleta"></i>&nbsp;'
		cadena = cadena + '<i class="fas fa-times fa-lg btn_cancel" row_id="fila_tipos_maleta_x" style="color:red;display:none;cursor:hand;cursor:pointer"'
		cadena = cadena + 'data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Cancelar"></i>&nbsp;'
		cadena = cadena + '<i class="fas fa-trash-alt fa-lg btn_delete" row_id="fila_tipos_maleta_x" style="color:darkred;display:none;cursor:hand;cursor:pointer"'
		cadena = cadena + 'data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Borrar El Tipo de Maleta"></i>'
		cadena = cadena + '</div>'
		cadena = cadena + '</td>'
		cadena = cadena + '<tr>'
