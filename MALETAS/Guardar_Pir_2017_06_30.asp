...
<%
		...
		if campo_fecha_pir<>request.form("txtfecha_pir_d") then		
			...
			cadena_pir = cadena_pir & "FECHA_PIR='" & request.form("txtfecha_pir_d") &"'"
		...
		if campo_fecha_orden<>request.form("txtfecha_orden_d") then		
			...
			cadena_pir = cadena_pir & "FECHA_ORDEN='" & request.form("txtfecha_orden_d") &"'"
		...
		if campo_fecha_desde_hasta<>request.form("txtfecha_desde_hasta_d") then		
			...
			cadena_pir = cadena_pir & "FECHA_DESDE_HASTA=CAST('" & request.form("txtfecha_desde_hasta_d") &"'AS DATETIME)"
			
			connmaletas.Execute cadena_historico,,adCmdText + adExecuteNoRecords
		end if
		
		if campo_tipo_equipaje<>request.form("txttipo_equipaje_d") then		
			cadena_historico="INSERT INTO HISTORICO_PIRS (ID_PIR, PIR, FECHA, ACCION, CAMPO, VALOR_ANTIGUO, VALOR_NUEVO,"
			cadena_historico=cadena_historico & "USUARIO, DESCRIPCION, TIPO_INCIDENCIA)"
			cadena_historico=cadena_historico & " VALUES (" & id_seleccionado & ", '" & request.form("txtpir_d") & "',"
			cadena_historico=cadena_historico & " GETDATE(), 'CAMBIO', 'TIPO EQUIPAJE', '" & campo_tipo_equipaje & "',"
			cadena_historico=cadena_historico & " '" & request.form("txttipo_equipaje_d") & "', '" & session("usuario") & "', NULL, NULL)"
			...
			cadena_pir = cadena_pir & "TIPO_EQUIPAJE_BAG_ORIGINAL='" & request.form("txttipo_equipaje_d") &"'"
			
			connmaletas.Execute cadena_historico,,adCmdText + adExecuteNoRecords
		end if
		
		if campo_marca<>request.form("txtmarca_d") then		
			cadena_historico="INSERT INTO HISTORICO_PIRS (ID_PIR, PIR, FECHA, ACCION, CAMPO, VALOR_ANTIGUO, VALOR_NUEVO,"
			cadena_historico=cadena_historico & "USUARIO, DESCRIPCION, TIPO_INCIDENCIA)"
			cadena_historico=cadena_historico & " VALUES (" & id_seleccionado & ", '" & request.form("txtpir_d") & "',"
			cadena_historico=cadena_historico & " GETDATE(), 'CAMBIO', 'MARCA', '" & campo_marca & "',"
			cadena_historico=cadena_historico & " '" & request.form("txtmarca_d") & "', '" & session("usuario") & "', NULL, NULL)"
			...
			cadena_pir = cadena_pir & "MARCA_BAG_ORIGINAL='" & request.form("txtmarca_d") &"'"
