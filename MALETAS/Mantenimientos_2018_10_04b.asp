							...
							<div class="col-sm-12 col-md-10 col-lg-10 mx-auto">
								<table class="table table-striped table-bordered">
									...
									<tbody>
										<tr>
											<td>
												<div class="col-sm-12 col-md-6 col-lg-4 mx-auto odd">
												...
												<div class="col-sm-12 col-md-6 col-lg-4 mx-auto even">
													<div class="custom-control custom-checkbox">
				  ...
				  j$.post("tojson/Obtener_Proveedores_Tipos_Maleta.asp"
					...
					, function(data){
							...
							j$.each(data.ROWSET, function(index) {
								...
								cadena+='<div class="col-sm-12 col-md-6 col-lg-4 mx-auto">'
								cadena+='<div class="custom-control custom-checkbox">'
								cadena+='<input type="checkbox" class="custom-control-input" name="chktipos_maleta_' + data.ROWSET[index].ID + '"'
								cadena+=' id="rbtipos_maleta_' + data.ROWSET[index].ID + '" onclick="mostrar_cmbempresa(this.name)">'
								cadena+='<label class="custom-control-label" for="rbtipos_maleta_3">' + data.ROWSET[index].DESCRIPCION_MALETA + '</label>'
								cadena+='</div>'
								cadena+='</div>'
        					});
