...
consultar_pirs = function() {  
      var err ="";
        ...
        if (typeof lst_pirs == "undefined") {
            console.log('creamos el datatable')
			console.log('parent urlbase: ' + parent.urlBase)
    ...
    */                                               
                                                    buttons:[{extend:"copy", text:'<i class="fa fa-files-o"></i>', titleAttr:"Copiar en Portapapeles"}, 
                                                             {extend:"excel", text:'<i class="fa fa-file-excel-o"></i>', titleAttr:"Exportar a Formato Excel", title:"Pirs", extension:".xls"}, 
                                                             {extend:"pdf", text:'<i class="fa fa-file-pdf-o"></i>', titleAttr:"Exportar a Formato PDF", title:"Pirs.pdf", orientation:"landscape"}, 
                                                             {extend:"print", text:"<i class='fa fa-print'></i>", titleAttr:"Vista Preliminar"}],
			  ...
			  console.log('solo actualizamos datatable')
              lst_pirs.ajax.url("tojson/obtener_pirs.asp?"+prm.toString());
              lst_pirs.ajax.reload();                  
            }       
      
      
     console.log('y nos salimos de la funcion de consultar')
  };
