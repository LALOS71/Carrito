				...
				<div class="row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8 col-md-8 col-lg-8">
							<div class="col-sm-12 col-md-12 col-lg-12">
									<label for="cmbreferencia_maleta_entregada_d" class="control-label">Buscar Referencia / Tipo Maleta / Tamaño / Color</label>
							...
							<div class="col-sm-12 col-md-12 col-lg-12">
								<div class="col-sm-3 col-md-3 col-lg-3">
									Referencia
									<input type="text" id="txtreferencia_maleta_entregada_d" class="form-control" required="" name="txtreferencia_maleta_entregada_d" value="<%=campo_color_bag_entregada%>" /> 
								</div>
								<div class="col-sm-3 col-md-3 col-lg-3">
