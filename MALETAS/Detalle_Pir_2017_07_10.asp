				...
				<div class="col-sm-12 col-md-12 col-lg-12">
						  <div class="col-sm-2 col-md-2 col-lg-2">
							...
							<div class="col-sm-2 col-md-2 col-lg-2">
								...
								<input type="text" id="txtfecha_inicio_d" class="form-control" required="" name="txtfecha_inicio_d" value="<%=campo_fecha_inicio%>" disabled /> 
							</div>
							<div class="col-sm-2 col-md-2 col-lg-2">
				...
				<div class="row">
					...
					<div class="form-group row">
					  	...
					  	<div class="col-sm-2 col-md-2 col-lg-2">
								...
								<input type="text" id="txtfecha_envio_d" class="form-control" required="" name="txtfecha_envio_d" value="<%=campo_fecha_envio%>" disabled /> 
							</div>
						<div class="col-sm-2 col-md-2 col-lg-2">
							<label for="txtfecha_entrega_pax_d" class="control-label">Fecha Entrega Pax</label>
							<input type="text" id="txtfecha_entrega_pax_d" class="form-control" required="" name="txtfecha_entrega_pax_d" value="<%=campo_fecha_entrega_pax%>" disabled /> 
						</div>
						<div class="col-sm-2 col-md-2 col-lg-2">
...
j$('#cmdguardar_pir').on('click', function() {
	...
	if (j$("#cmbestado_d").val()=='AUTORIZADO')
		{
		console.log('se ha seleccionado incidencia')
	...
	if (j$("#cmbestado_d").val()=='ENTREGADO')
		{
		if (j$("#cmbtipo_maleta_entregada_d").val()=='')
			{
