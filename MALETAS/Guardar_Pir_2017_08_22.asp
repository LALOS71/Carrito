...
<%
		...
		if id_seleccionado<>"" then 'ES UNA MODIFICACION
			...
			if campo_danno_cierres_maleta_bag_original<>actual_danno_cierres_maleta then		
				...
				cadena_historico=cadena_historico & "USUARIO, DESCRIPCION, TIPO_INCIDENCIA)"
				cadena_historico=cadena_historico & " VALUES (" & id_seleccionado & ", '" & request.form("txtpir_d") & "',"
				cadena_historico=cadena_historico & " GETDATE(), 'MODIFICA', 'DAÑO CIERRE BAG', '" & campo_danno_cierres_maleta_bag_original & "',"
		...
		ELSE '**************************LA PARTE DE LAS ALTAS DE PIR
			...
			cadena_campos = "FECHA_ORDEN, ORDEN, AGENTE, EXPEDIENTE, PIR, FECHA_PIR, TAG, NOMBRE, APELLIDOS, DNI, MOVIL, FIJO"
			cadena_campos = cadena_campos & ", DIRECCION_ENTREGA, CP_ENTREGA, TIPO_DIRECCION_ENTREGA, DESDE_HASTA, FECHA_DESDE_HASTA"
			cadena_campos = cadena_campos & ", OBSERVACIONES, TIPO_EQUIPAJE_BAG_ORIGINAL,ESTADO"
			'cadena_campos = cadena_campos & ", OBSERVACIONES, TIPO_EQUIPAJE_BAG_ORIGINAL, MARCA_BAG_ORIGINAL, MODELO_BAG_ORIGINAL"
			'cadena_campos = cadena_campos & ", MATERIAL_BAG_ORIGINAL, COLOR_BAG_ORIGINAL, LARGO_BAG_ORIGINAL, ALTO_BAG_ORIGINAL"
			'cadena_campos = cadena_campos & ", ANCHO_BAG_ORIGINAL, DANNO_RUEDAS_BAG_ORIGINAL, DANNO_ASAS_BAG_ORIGINAL"
			'cadena_campos = cadena_campos & ", DANNO_CIERRES_BAG_ORIGINAL, DANNO_CREMALLERA_BAG_ORIGINAL, DANNO, EQUIPAJE, RUTA"
			'cadena_campos = cadena_campos & ", VUELOS, TIPO_BAG_ORIGINAL, FECHA_INICIO, FECHA_ENVIO, FECHA_ENTREGA_PAX"
			'cadena_campos = cadena_campos & ", PLAZO_ENTREGA_EN_DIAS, INCIDENCIA_TRANSPORTE, INCIDENCIA_MALETA, OTRAS_INCIDENCIAS"
			'cadena_campos = cadena_campos & ", TIPO_BAG_ENTREGADA, TAMANNO_BAG_ENTREGADA, REFERENCIA_BAG_ENTREGADA, COLOR_BAG_ENTREGADA"
			'cadena_campos = cadena_campos & ", NUM_EXPEDICION, ESTADO, DANNO_OTROS_BAG_ORIGINAL, DANNO_CUERPO_MALETA_BAG_ORIGINAL"
			'cadena_campos = cadena_campos & ", DANNO_CIERRES_MALETA_BAG_ORIGINAL, IMPORTE_FACTURACION, FECHA_FACTURACION"
			'cadena_campos = cadena_campos & ", COSTES, PROVEEDOR"
			
			cadena_valores="'" & cdate(request.form("txtfecha_orden_d")) & "'"
			cadena_valores=cadena_valores & ", NULL, NULL, NULL"
