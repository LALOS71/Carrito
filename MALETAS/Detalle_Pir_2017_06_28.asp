...
<head>
	...
	.popover_usuario { background-color:#8a6d3b; }
	</style>
    	...
    	<div class="modal-content">	    
        	...
        	<div class="modal-body">
				<div class="form-group row">
					...
					<div class="col-sm-3 col-md-3 col-lg-3">
						<button type="button" class="btn btn-primary btn-md" id="cmdaceptar_tipo_incidencia" name="cmdaceptar_tipo_incidencia">
																...
																{data:function(row, type, val, meta) {                                                                                                                   
																		...
																		if (row.NOMBRE_USUARIO=='')
																			...
																			cadena='<i class="fa fa-user-o" aria-hidden="true" style="cursor:pointer"' +
																						...
																						'data-placement="top"' + 
																						'data-trigger="hover"' +
																						'data-content="<span class=\'popover_usuario\' style=\'color:blue;\'><i class=\'fa fa-user-o fa-lg\'></i>&nbsp;' + cadena_usuario + '"></i></span>'
																			}
