...
set detalle_pir=Server.CreateObject("ADODB.Recordset")
	with detalle_pir
		...
		.Source= .Source & ", DANNO, EQUIPAJE, RUTA, VUELOS, TIPO_BAG_ORIGINAL, FECHA_INICIO, IMPORTE_FACTURACION, FECHA_FACTURACION"
		.Source= .Source & ", FECHA_ENVIO, FECHA_ENTREGA_PAX, PLAZO_ENTREGA_EN_DIAS, INCIDENCIA_TRANSPORTE, INCIDENCIA_MALETA"
		.Source= .Source & ", OTRAS_INCIDENCIAS, TIPO_BAG_ENTREGADA, TAMANNO_BAG_ENTREGADA, REFERENCIA_BAG_ENTREGADA"
		.Source= .Source & ", COLOR_BAG_ENTREGADA, NUM_EXPEDICION, COSTES, ESTADO"
	...
	if campo_danno_cierres_maleta_bag_original="" then
	  	campo_danno_cierres_maleta_bag_original=false
	end if
					...
					<div class="row">
						<div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group row">
                            <div class="col-sm-2 col-md-2 col-lg-2">
    	                        ...
    	                        <input type="text" class="form-control" style="width: 100%;"  id="txtpir_d" name="txtpir_d" value="<%=campo_pir%>" disabled/>
							</div>
							<div class="col-sm-2 col-md-2 col-lg-2">
								<label for="txtfecha_pir_d" class="control-label">Fecha PIR</label>
								<input type="text" id="txtfecha_pir_d" class="form-control" required="" name="txtfecha_pir_d" value="<%=campo_fecha_pir%>"  disabled/> 
							</div>
							<div class="col-sm-2 col-md-2 col-lg-2">
								<label for="txtfecha_orden_d" class="control-label">Fecha Orden</label>
								<input type="text" id="txtfecha_orden_d" class="form-control" required="" name="txtfecha_orden_d" value="<%=campo_fecha_orden%>"  disabled/> 
							</div>
							<div class="col-sm-2 col-md-2 col-lg-2">
								<label for="txttag_d" class="control-label">TAG</label>
								<input type="text" id="txttag_d" class="form-control" required="" name="txttag_d" value="<%=campo_tag%>"  disabled/> 
							</div>
                          </div>
						</div>
						...
						<div class="col-sm-12 col-md-12 col-lg-12">  
						  <div class="form-group row">
							...
							<div class="col-sm-4 col-md-4 col-lg-4">
								...
								<input type="text" id="txtruta_d" class="form-control" required="" name="txtruta_d" value="<%=campo_ruta%>"  disabled/> 
							</div>
							<div class="col-sm-5 col-md-5 col-lg-5">
								<label for="txtvuelos_d" class="control-label">Vuelos</label>
								<input type="text" id="txtvuelos_d" class="form-control" required="" name="txtvuelos_d" value="<%=campo_vuelos%>"  disabled/> 
							</div>
						...
						<div class="col-sm-12 col-md-12 col-lg-12">  
						  <div class="form-group row">
							...
							<div class="col-sm-2 col-md-2 col-lg-2">
								<label for="chkdanno_cierres_maleta_d" class="control-label"  style="width:100%"
									data-toggle="popover" 
									data-placement="top" 
									data-trigger="hover"
									data-content="Daño Cierres Maleta"
									>D. Cier. Maleta</label>
								<div class="clearfix visible-md-block"></div>
			...
			<div class="form-group row">
				<div class="col-sm-12 col-md-12 col-lg-12">
						  <div class="col-sm-2 col-md-2 col-lg-2">
							...
							<%if campo_estado="PTE AUTORIZACION" then%>
								<div class="col-sm-4 col-md-4 col-lg-4">
...
j$(document).ready(function () {
	...
	j$("#chkdanno_cierres_maleta_d").bootstrapSwitch("state", <%=lcase(campo_danno_cierres_maleta_bag_original)%>);
