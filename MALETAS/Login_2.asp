...
<html>
  ...
  <!-- FIN capa mensajes -->
    ...
    <div class="container overlay">
      ...
      <form class="form-signin" method="post" id="frmlogin" name="frmlogin" action="http://carrito.globalia-artesgraficas.com/act_dir/Validar_Usuario_Actdir.asp">
...
j$("#frmlogin__").submit(function( event ) {			
