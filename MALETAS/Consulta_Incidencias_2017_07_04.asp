                                                                      	...
                                                                      	switch(row.ESTADO) {
																			...
																			if (row.ESTADO=='INCIDENCIA')	
																				...
																				*/
																			  	...
																			  	{
																				cadena='<i class="fa fa-suitcase fa-x2" aria-hidden="true"  style="color:' + colorcillo + '"></i>'
...
mostrar_detalle_pir = function(pagina, parametro_id, parametro_pir){
    ...
    url_iframe=pagina + '?id=' + parametro_id
