		...
		if id_seleccionado<>"" then 'ES UNA MODIFICACION
			...
			if session("perfil_usuario")="ADMINISTRADOR" then
				...
				if campo_fecha_inicio<>request.form("txtfecha_inicio_d") then		
					...
					cadena_historico=cadena_historico & " '" & request.form("txtfecha_inicio_d") & "', '" & session("usuario") & "', NULL, NULL)"
					...
					cadena_pir = cadena_pir & "FECHA_INICIO='" & request.form("txtfecha_inicio_d") &"'"
