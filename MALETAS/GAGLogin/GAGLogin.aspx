...
<head runat="server">
    ...
    <!-- Iconos Bootstrap http://fortawesome.github.io/Font-Awesome/ -->
    <!-- Bootstrap core CSS -->
...
<form id="form1" action="http://carrito.globalia-artesgraficas.com/GAG/Abrir_Lista_Articulos.asp" runat="server">  

<%-- 
    <form id="form1" action="http://carrito.globalia-artesgraficas.com/GAG/Abrir_Lista_Articulos.asp" runat="server">        PROD
    <form id="form1" action="http://192.168.153.132/asp/carrito_imprenta_GAG/GAG/Abrir_Lista_Articulos.asp" runat="server">   DES
--%> 

    
    <div id="frmLogin" role="dialog" >
        <div class="modal-dialog" style="width:5    00px;">  
            <div class="modal-content">
                <div class="modal-header" style="padding: 35px 50px;">
                    
                    <h4><span class="glyphicon glyphicon-lock"></span>Identificación Peticiones Material Globalia</h4>
                ...
                <div class="modal-body" style="padding: 20px 30px;">
                    <div role="form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="tbUsuario" runat="server" autofocus="" placeholder="Indique Nº. empleado">
                        </div>
                        <div class="form-group">
                            <label for="psw"><span class="glyphicon glyphicon-eye-open fa-2x"></span>Contraseña</label>
                            <input type="password" class="form-control " id="tbContrasena" placeholder="Indique Contraseña">
                        </div>  

                        <div id="pnClienteSel" class="form-group" hidden>
                        ...
                        <div id="pnClienteSel_" class="panel panel-primary" hidden>
                ...
                <div class="modal-footer">                
                    ...
                    <%--<p> Registro o Nueva Alta ? <a href="#" >Solicitar</a></p>--%>
                </div>
            </div>
