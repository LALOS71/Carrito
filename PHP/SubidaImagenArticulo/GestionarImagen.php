...
class GestionarImagen
{
    ...
    public static function subirImagen($imagen): ?string
    {
        ...
        if ($esImagen === false) {
            ...
            // echo json_encode(array("error" => "Selecciona una imagen"));
        ...
        if ($_SESSION["error"] == "") {
            ...
            if ($resultado === false) {
                ...
                echo json_encode(array("success" => "Archivo subido"));
            }
            // http_response_code(200);
        }else{
            echo json_encode(array("error" => $_SESSION['error']));
            // echo json_encode(array("error" => "El archivo debe ser un JPG"));
        }
        return $nombreImagen;
    }
