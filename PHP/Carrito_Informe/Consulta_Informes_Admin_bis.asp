	...
	set empresas=Server.CreateObject("ADODB.Recordset")
		...
		with consumos
			...
			if agrupacion_seleccionada="empresa" then
				...
				.Source= .Source & ", ROUND(SUM(A.CANTIDAD * B.PRECIO_COSTE), 2) AS TOTAL_PRECIO_COSTE_PEDIDO"
				...
				'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
				'NUEVA CONSULTA A�ADIENDO LAS DEVOLUCIONES Y LA FECHA DE SALIDA DEL PRODUCTO ASOCIADO
				...
				.Source= .Source & ", ROUND(SUM(B.CANTIDAD * D.PRECIO_COSTE), 2) AS TOTAL_PRECIO_COSTE_PEDIDO"
			...
			if articulos_sin_consumo_seleccionada="SI" then
				...
				cadena_envios=cadena_envios & ", ROUND(SUM(B.CANTIDAD * PEDIDOS_DETALLES.PRECIO_COSTE), 2) AS TOTAL_PRECIO_COSTE_PEDIDO"
				...
				consulta_total=consulta_total & ", ISNULL(B.TOTAL_PRECIO_COSTE_PEDIDO, 0) AS TOTAL_PRECIO_COSTE_PEDIDO"
...
{
	Actualizar_Combos('Obtener_Articulos.asp', '', valor,'capa_articulos', orden, '')
	/*
	if (valor!='')
		{
		...
		<div class="sidebarcell">
			...
			<div class="contentcell">
				<div class="sidefreetext" ><div align="left">
					...
					� <a href="Consulta_Articulos_Admin.asp">Art�culos</a><br />
				...
				<div class="comment_text__"> 
					...
					<table width="95%" cellspacing="6" cellpadding="0" class="logintable" align="center">
						<tr>
							...
							<td class="al">
								<span class='fontbold'>Opciones de B�squeda</span>
							</td>
						</tr>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="txtfecha_inicio" id="txtfecha_inicio" value="<%=fecha_i%>" size="10">
                            <div class="input-group-append">
                                <a href="javascript:cal1.popup();" class="input-group-text"><img src="img/cal.gif" width="16" height="16" alt="Pulsa Aqui para Seleccionar una Fecha de Inicio"></a>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="txtfecha_fin" id="txtfecha_fin" value="<%=fecha_f%>" size="10">
                            <div class="input-group-append">
                                <a href="javascript:cal2.popup();" class="input-group-text"><img src="img/cal.gif" width="16" height="16" alt="Pulsa Aqui para Seleccionar una Fecha de Fin"></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card bg-primary text-white">
                <div class="card-body">
                    <div class="form-check">
                        ...
                        <label class="form-check-label font-weight-bold" for="chkdiferenciar_sucursales">Diferenciar Sucursales</label>
                    </div>
        ...
        <div class="col-md-6">
            <div class="card bg-info text-white">
                <div class="card-body">
                    ...
                    <div id="fila_articulos_sin_consumo" style="display:none">
                        <div class="form-check">
								...
								<div id="main">
										<%if agrupacion_seleccionada="empresa" then%>
											...
											<table border="0" cellpadding="1" cellspacing="1" width="99%" class="info_table">
                                              ...
                                              <%else%>
                                              <tr>
                                                <td align="center" colspan="5"><b><font class="fontbold">NO Hay Consumos Que Cumplan El Critero de B�squeda...</font></b><br />
                                                </td>
                                              </tr>
                                              <%end if%>
                                            </table>
