...
$writer->save($_SERVER['DOCUMENT_ROOT'] . '\PHP\files\resultados.xlsx'); 

echo "<BR><br>...FICHERO resultados.xlsx GENERADO...";
...
$srcFile = $_SERVER['DOCUMENT_ROOT'] . '\PHP\files\resultados.xlsx';
$dstFile = '/resultados.xlsx';
