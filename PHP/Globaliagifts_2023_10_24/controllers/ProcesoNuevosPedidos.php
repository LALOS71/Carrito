...
class ProcesoNuevosPedidos extends TronShop
{
    ...
    public function __construct($debug = false)
    {
        ...
        */
        ...
        foreach ($orders as &$order) {
            ...
            //para que ahora probando los coja todos
            ...
            if($order->getNumber()== 'W202300000113'){
                echo '<br>***************************************';
                echo '<br>PROCESONUEVOSPEDIDOS..... cus devuelto de getcustomerapi.....';
                echo "<pre>";
                print_r($cus);
                echo "</pre><br>";
                echo '<br>***************************************';
            ...
            if(!$albaran = $ac->existeAlbaranPorNPedido($order)) {
                ...
                if($order->getNumber()== 'W202300000113'){
                    echo '<br>***************************************';
                    echo '<br>PEDIDOS DEL NUEVO ALBARAN.....';
                    echo "<pre>";
                    print_r($order);
                    echo "</pre><br>";
                    echo '<br>***************************************';
    ...
    public function getCustomerAPI(orders &$order)
    {
        if($order->getNumber()== 'W202300000113'){
            echo '<br>***************************************';
            echo '<br>PROCESONUEVOSPEDIDOS - getCustomerAPI.....';
            echo '<br>$order->getCustomerPersonId().....' . $order->getCustomerPersonId();
        }
        ...
        if($order->getNumber()== 'W202300000113'){
            echo '<br>';
            echo '<br>CUSTOMER DEVUELTO POR EL API DE TROMSHOP.....';
            echo "<pre>";
            print_r($customer);
            echo "</pre><br>";
            echo '<br>';
        ...
        if (!$gagCustomer = $cC->clienteExists($order)) {
            if($order->getNumber()== 'W202300000113'){
                echo "<br>************************** DENTRO DE GETCUSTOMERAPI (ANTES DE CREAR CLIENTE)****************";
                echo "<br>ORDER:";
                echo "<pre>";
                print_r($order);
                echo "</pre>";
        ...
        if($order->getNumber()== 'W202300000113'){
            echo '<br>***************************************';
            echo '<br>CLIENTE ASIGNADO AL PEDIDO.....';
            echo "<pre>";
            print_r($gagCustomer);
            echo "</pre>";
            echo '<br>***************************************';
