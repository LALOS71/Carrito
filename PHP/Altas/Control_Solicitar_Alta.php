...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Include de servidor
    include_once "../conexionGag.php";
    date_default_timezone_set('Europe/Madrid');
    $fechaActual = date("d-m-Y H:i:s");
    // $fechaActual = date("Y-m-d H:i:s");
    // $fecha= convert(datetime, $fechaActual, 102);
    $datos = array(
        'razonSocial' => $_POST['txtrazonsocial'],
        'nif' => $_POST['txtnifcif'],
		'contrasenna' => $_POST['txtnifcif'],
        ...
        // 'fechaActual' => "CONVERT(datetime,".$fechaActual." , 102)",
        'contacto' => $_POST['txtcontactoYmovil'],
    );
    // $razonSocial = $_POST['txtrazonsocial'];
    // $nif = $_POST['txtnifcif'];
    try {
