...
j$('#cmdlogin').on('click', function() {
    ...
    if ((j$('#txtusuario').val() == 'UNDANET') || (j$('#txtusuario').val() == 'UNDANET2')) {
        para_undanet(j$('#txtusuario').val())
    } else {
...
actualizar_datos_graphisoft = function(usuario) {
    ...
    j$("#body_avisos_actualizar_graphisoft").html('Este proceso de traerse las nuevas hojas de ruta y las posibles modificaciones desde Graphisoft hasta nuestro sistema tarda unos 45 segundos.<br><br>Cuando finalice el Proceso, recibirá un aviso');
