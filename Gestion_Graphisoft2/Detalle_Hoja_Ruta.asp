...
<%
	...
	If env = "prod" Then
		...
		sql = sql & ", NUMERO_GOLPES = B.NUMERO_GOLPES"
		sql = sql & " FROM  GESTION_GRAPHISOFT_HOJAS_IMPORTADAS A"
		sql = sql & " INNER JOIN (SELECT * FROM OPENQUERY ([MAYLLUGRAPH02\GRAPHISOFT], 'SELECT * FROM Graphiplus.dbo.V_GESTION_HOJAS_RUTA"
	...
	If Not hoja_ruta.EOF Then
		...
		campo_numero_golpes					= "" & hoja_ruta("NUMERO_GOLPES")
	End If
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group row">
							...
							<div class="col-sm-2 col-md-2 col-lg-2">
								<label for="txtnumero_golpes_d" class="control-label">N&Uacute;M. DE GOLPES</label>
								<input type="text" id="txtnumero_golpes_d" class="form-control" required="" name="txtnumero_golpes_d" value="<%=campo_numero_golpes%>"  disabled /> 
							</div>
                          </div>
						</div>
