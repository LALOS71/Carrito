						...
						<div class="form-group row mx-2">
							...
							<div class="col-sm-6 col-md-6 col-lg-6">
								...
								<div class="form-check">
									...
									<label class="radio-inline">
									  <input type="radio" name="chkdel_grupo" value="GRUPO"> Clientes del Grupo&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									</label>
									<label class="radio-inline">
									  <input type="radio" name="chkdel_grupo" value="EXTERNO"> Clientes Externos
									</label>
									)
								</div>
...
consultar_hojas_ruta = function () {
    ...
    if (typeof lst_presupuesto == "undefined") {
				...
				if (parametro_id_estado_nuevo=='5' || parametro_id_estado_nuevo=='6') // SI ES EN EN ESTUDIO O RECHAZADO HAY QUE PONER EL SUBESTADO
					...
					if (j$("#cmbsubestados_datatable_" + parametro_id_presupuesto).val()=='')
						...
						console.log('el combo esta vacio')
						 ...
						 bootbox.alert({
								//size: 'large',
								message: '<h5>Se ha de Seleccionar un Subestado.</h5>'
								//callback: function () {return false;}
							})
						}
        ...
        j$('#lista_presupuestos').on('click', '.boton_cancelar_guardar_estado', function () {
			...
			console.log('cancelamos el presupuesto: ' + valor_id_presupuesto + ' con estado anterior: ' + valor_id_estado_anterior -+' y subestado anterior: ' + valor_id_subestado_anterior)
				...
				j$.ajax({
					...
					success:
						function (data) {
							...
							switch (data) {
								case '1':  //se encuentra dado de alta en la gestion de maletas  
									cadena = 'Subestado Modificado Correctamente.';
									row.ID_SUBESTADO = parametro_id_estado_nuevo;
