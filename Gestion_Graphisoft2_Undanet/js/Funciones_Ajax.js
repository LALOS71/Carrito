...
function Actualizar_Combos (pagina, empresa, valor_seleccionado, divContenedora, ordenacion, borrados)
  {
	var contenedor = document.getElementById(divContenedora);  	
	
	
		//console.log('dentro de actualizar combos')	
		//alert('Actualizamos combo de la Capa ' + divContenedora)
 		//Se contruye la url pasando, como parámetro, el valor seleccionado
		var url_final = pagina + '?empresa=' + empresa + '&valor_seleccionado=' + valor_seleccionado + '&orden=' + ordenacion + '&borrados=' + borrados
