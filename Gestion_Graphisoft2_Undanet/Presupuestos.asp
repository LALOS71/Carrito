...
consultar_hojas_ruta = function () {
    ...
    if (typeof lst_presupuesto == "undefined") {
					...
					render: function(data, type, row){
							...
							switch(type) {
									...
									default:
											...
											if ((data=='' || data==null) && row.ID_ESTADO!=3)
												{
												cadena_total=''
												}
											  else
        ...
        j$('#lista_presupuestos').on('change', '.cmbestados_datatable', function () {
			...
			if (j$(this).val()==5 || j$(this).val()==6 || j$(this).val()==3){
        ...
        j$('#lista_presupuestos').on('click', '.boton_guardar_estado', function () {
			...
			if (parametro_id_estado_nuevo==5 || parametro_id_estado_nuevo==3)
				{
            ...
            if (controles_visibles > 1) {
				...
				if (parametro_id_estado_nuevo=='5' || parametro_id_estado_nuevo=='3') // SI ES EN EN ESTUDIO HAY QUE PONER LA PROXIMA REVISION
					{
