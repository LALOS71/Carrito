...
<%
	...
	with pedidos
		...
		.Source= .Source & " where a.id in (37558, 38052, 36255, 38983, 39490, 39532)"
		'.Source= .Source & " where c.id in (687,688,943,689,945,948,949,764,716,561,601,1349,2133,729,730,731,732,801,2440,2239,2240,2241,763,765,2622,2623,2624,2625,2179,582,2473,1172)"
...
<table border="1" cellpadding="1" cellspacing="1" width="99%">
                                    <tr style="background-color:#FCFCFC" valign="top">
									  ...
									  <th width="91" class="menuhdr">Web</th>
									  ...
									  <th width="91" class="menuhdr">Pa&iacute;s</th>
									  ...
									  <th width="91" class="menuhdr">Fecha Desde</th>
									  <th width="91" class="menuhdr">Fecha Hasta</th>
									  <th width="91" class="menuhdr">Porcentaje (%)</th>
									  <th width="91" class="menuhdr">Servicios</th>
									  <th width="91" class="menuhdr">Observaciones</th>
									  <th width="91" class="menuhdr">Ciudad</th>
									  <th width="91" class="menuhdr">Razon Social</th>
									  <th width="91" class="menuhdr">Departamento</th>
											...
											if fso_json.FileExists(ruta_fichero_json) then
   											...
   											'end if
												...
												<tr valign="top" >
													...
													<td width="81">
														<%If CheckProperty(plantillas.plantillas.get(i), "pais") Then
																	response.write(plantillas.plantillas.get(i).pais)
														End If%>
													</td>
												  	<td width="81">
													...
													<td width="81">
														<%If CheckProperty(plantillas.plantillas.get(i), "fecha_desde") Then
																	response.write(plantillas.plantillas.get(i).fecha_desde)
														End If%>
													</td>
													<td width="81">
														<%If CheckProperty(plantillas.plantillas.get(i), "fecha_hasta") Then
																	response.write(plantillas.plantillas.get(i).fecha_hasta)
														End If%>
													</td>
													<td width="81">
														<%If CheckProperty(plantillas.plantillas.get(i), "porcentaje") Then
																	response.write(plantillas.plantillas.get(i).porcentaje)
														End If%>
													</td>
													<td width="81">
														<%If CheckProperty(plantillas.plantillas.get(i), "servicios") Then
																	response.write(plantillas.plantillas.get(i).servicios)
														End If%>
													</td>
													<td width="81">
														<%If CheckProperty(plantillas.plantillas.get(i), "observaciones") Then
																	response.write(plantillas.plantillas.get(i).observaciones)
														End If%>
													</td>
													<td width="81">
														<%If CheckProperty(plantillas.plantillas.get(i), "ciudad") Then
																	response.write(plantillas.plantillas.get(i).ciudad)
														End If%>
													</td>
													<td width="81">
														<%If CheckProperty(plantillas.plantillas.get(i), "razon_social") Then
																	response.write(plantillas.plantillas.get(i).razon_social)
														End If%>
													</td>
													<td width="81">
														<%If CheckProperty(plantillas.plantillas.get(i), "departamento") Then
																	response.write(plantillas.plantillas.get(i).departamento)
														End If%>
													</td>
												</tr>
												<%next%>
