...
<%
	...
	'response.write("<br>nombre establecimiento: " & nombre_establecimiento)
		...
		cadena_sql="SELECT A.ID, A.ID_DEVOLUCION, A.ID_PEDIDO, B.CODIGO_SAP, REPLACE(B.DESCRIPCION, '""', '____') as DESCRIPCION"
	...
	cadena_detalles_devolucion=REPLACE(cadena_detalles_devolucion,"____", "\""")
