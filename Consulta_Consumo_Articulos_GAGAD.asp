							...
							<td width="760">
								<div id="main">							  
								  <table border="0" cellpadding="1" cellspacing="1" width="99%" class="info_table">
                                    ...
                                    <%else%>
                                    <tr>
                                      <td bgcolor="#999966" align="center" colspan="7"><b><font class="fontbold">NO Hay Hoteles Que Cumplan El Critero de B�squeda...</font></b><br />
                                      </td>
                                    </tr>
                                    <%end if%>
                                  </table>
		  ...
		  <div class="submit_btn_container">	
					...
					<table width="13%" border="0" cellpadding="0" cellspacing="0" align="center" class="info_column">
						<tr>
							<td>
								<div align="right">
								  <input class="submitbtn" type="submit" name="nuevo_hotel" id="nuevo_hotel" value="A�adir Hotel" onclick="mostrar_hotel(0,'ALTA');return false" />
								</div>
