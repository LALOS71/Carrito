...
.Estilo1 {font-family: Verdana, Arial, Helvetica, sans-serif; color:#000000; font-weight: bold; font-size: 15px; padding-bottom:5px}
</style>
...
<DIV align=center><BR>
  ...
  <TR>
        ...
        <TD height="128" width="641" align="center" valign="middle" bgcolor="#dddddd">
			<%if not sucursales.eof then%>
					...
					<table border="0" width="97%" cellspacing="0">
                        ...
                        <tr> 
      					...
      					<tr> 
        					...
        					<td width="435" height="29" colspan="2"> 
