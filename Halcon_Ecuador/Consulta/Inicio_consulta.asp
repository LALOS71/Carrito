...
<!--#include file="../cgi-bin/formatear_fechas.inc"-->
<%
...
<script type="text/javascript" language="javascript" src="../cgi-bin/Comprobar_Formato_Datos.js">
</script>
...
<form name="f_inicio" method="post" action="consulta.asp" target="_parent" onsubmit="return validar()">
  ...
  <TABLE align="center" cellSpacing=0 cellPadding=0 width="604" border=0>
    	<TBODY> 
  ...
  <TR>
        ...
        <TD height="128" width="710" align="center" valign="middle" bgcolor="#0730aa">
		<%if not sucursales.eof then%>
        <br>
			<table border="0" width="522" cellspacing="0" align="center">
				...
				<tr bgcolor="#0730aa"> 
      				...
      				<td height="29" ><input class="cajatexto" type="text" name="c_sucursal" id="c_sucursal" maxlength="25" size="20" onKeyUp="cambia_combo()" style=" width:350px; border-radius:5px; height:40px;border-style:groove;FONT-WEIGHT: bold;BACKGROUND-COLOR: #ffffff"></td>
                    <td width="16">&nbsp;</td>
                  <td width="10"> <div align="left" class="Estilo1"></div></td>
                  <td width="358"><select class="cajatexto" id="combo_sucursal"  name="combo_sucursal" onChange="cambia_sucursal()" style=" width:350px; border-radius:5px; height:40px;border-style:groove;FONT-WEIGHT: bold;BACKGROUND-COLOR: #ffffff">
          <option value="000">Seleciona una sucursal</option>
      ...
      <td width="358" height="29"><input class="cajatexto" type="text" name="C_Desde" size="10" value="<%=fechai%>" style=" width:350; border-radius:5px; height:40px;border-style:groove;FONT-WEIGHT: bold;BACKGROUND-COLOR: #e6e6ff"></td>
      ...
      <td width="10" height="29"> <div align="left" class="Estilo1"></div></td>
      <td width="358" height="29"><input class="cajatexto" type="text" name="C_hasta" size="10" value="<%=fechaf%>" style=" width:350px; border-radius:5px; height:40px;border-style:groove;FONT-WEIGHT: bold;BACKGROUND-COLOR: #e6e6ff"></td>
      <td width="16" height="29"><a href="javascript:cal1.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Pulsa Aqui para Seleccionar una Fecha de Inicio"></a></td>
    </tr>
    ...
    <tr bgcolor="#0730aa"> 
      ...
      <td height="21" width="113" class="Estilo1"> <div align="right">Todos: <input type="radio" name="opcion_consulta" value="TODOS"> </td>
