...
function mostrar(trozo)
	...
	function quitar(trozo)
		{
		console.log('dentro de quitar')
		console.log('trozo: ' + trozo)
		var texto;
		texto='document.all.' + trozo + '.style.visibility=' + '"hidden"';
		console.log('texto: ' + texto)
		eval(texto);
		console.log('final de quitar')
		}
		
		function quitartodoflechas()
		{
			console.log('dentro de quitar todo flechas')
			quitar('flechaazul1')
			quitar('flechaazul2')
			quitar('flechaazul3')
		...
		function quitartodo()
		{
			console.log('dentro de quitar todo')
			quitar('peticiones')
  	...
  	<TR>
        ...
        <TD bgColor=#e6e6e6 height="55" align="center">
			<table width="97%" border="0">
    			...
    			<tr bgcolor="#CCCCCC"> 
      				<td colspan="2" height="24" bordercolor="#000066" bgcolor="#CCFFCC"><img id="flechaazul2" name="flechaazul2" style="visibility:hidden" src="Imagenes/flechita_azul.gif" width="11" height="13">&nbsp;<b><a class="enlace" href="Consulta/Inicio_consulta.asp?logo=<%=logotipo_empresa%>&codigo_empresa=<%=codigo_empresa%>" onmouseover="mostrar('flechaazul2')" target="right">Consultar</a></b></td>
    			</tr>
    			<tr bgcolor="#CCCCCC"> 
      				<td colspan="2" bordercolor="#000066" bgcolor="#CCFFCC">&nbsp;</td>
    			</tr>
				<tr bgcolor="#CCCCCC"> 
      				<td colspan="2" height="24" bordercolor="#000066" bgcolor="#CCFFCC"><img id="flechaazul3" name="flechaazul3" style="visibility:hidden" src="Imagenes/flechita_azul.gif" width="11" height="13">&nbsp;<b><a class="enlace" href="Manual/Manual_Peticiones.htm" onmouseover="mostrar('flechaazul3')" target="right">Manual</a></b></td>
    			</tr>
    			<tr bgcolor="#CCCCCC"> 
      				<td colspan="2" bordercolor="#000066" bgcolor="#CCFFCC">&nbsp;</td>
    			</tr>
