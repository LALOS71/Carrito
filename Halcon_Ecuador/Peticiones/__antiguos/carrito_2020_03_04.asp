   ...
   function mover_formulario(objetivo)
   {
	...
	function dato_a_comprobar(numero)
	{
		...
		for (m=1;m<=numero; m++ )
			...
			if ((articulo==5632)||(articulo==5633)||(articulo==5598)||(articulo==5599)||(articulo==5586)||(articulo==5587)||(articulo==5445)||(articulo==5446)||(articulo==1798)||(articulo==5448)||(articulo==5449)||(articulo==5450)||(articulo==5521)||(articulo==5522))
				{
