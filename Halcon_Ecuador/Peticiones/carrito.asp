   ...
   function mover_formulario(objetivo)
   {
	...
	function dato_a_comprobar(numero)
	{
		...
		for (m=1;m<=numero; m++ )
			...
			//5632 y 5633 son los altavoces bluetooh
			//5695 y 5696 son Maleta Campaña Senior
			//5697 y 5698 son Maleta Campaña Circuitos Culturales
			//if ((articulo==4875)||(articulo==4876))
			if ((articulo==5697)||(articulo==5698)||(articulo==5695)||(articulo==5696)||(articulo==5632)||(articulo==5633)||(articulo==5598)||(articulo==5599)||(articulo==5586)||(articulo==5587)||(articulo==5445)||(articulo==5446)||(articulo==1798)||(articulo==5448)||(articulo==5449)||(articulo==5450)||(articulo==5521)||(articulo==5522))
				{
