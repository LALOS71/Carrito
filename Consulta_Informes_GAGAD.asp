		...
		<div class="sidebarcell">
			...
			<div class="contentcell">
				<div class="sidefreetext" ><div align="left">
					...
					� <a href="Consulta_Informe_Stock_Valorado_GAGAD.asp">Informe Stock Valorado </a><br /><br />									
	...
	<td valign="top">
		<div id="main">
				...
				<div class="comment_text__"> 
					<form name="frmbuscar_consumos" id="frmbuscar_consumos" method="post" action="Consulta_Informes_GAGAD.asp">
							...
							<td width="50%">
								...
								<tr>
									<td width="28%" style="padding:10px">
										...
										<span class='fontbold' style="color:#000000 ">Diferenciar Art�culos</span>
									</td>
						...
						<tr>
							<td width="50%" >
								...
								<tr>
									...
									<td width="72%" style="color:#000000 ">(util para BARCEL�, para obtener los consumos individualizados por marca (Barcelo, Confort, Premium))</td>
