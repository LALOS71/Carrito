		...
		<div class="sidebarcell">
			...
			<div class="contentcell">
				<div class="sidefreetext" ><div align="left">
					� <a href="Lista_Articulos_Central_AD.asp">Consultar Art�culos <%=session("usuario_empresa")%></a>
					<br />
	...
	<td width="713">
		<div id="main">
				...
				<div class="comment_text"> 
					<form name="frmconsulta_pedidos" action="Consulta_Pedidos_Central_AD.asp" method="post">
