			...
			<td>
				<table width="626" id="tabla_elemento">
					<tr>
						...
						<td colspan="2" class="obligatorio texto_celda">&nbsp;Expediente</td>
						<td rowspan="2" align="center" class="eliminar texto_celda boton_celda "><%=plantilla_personalizacion_boton_eliminar%></td>
					</tr>
					<tr>
						<td colspan="2"><input type="text" class="nombre_grupo_tarjeta" size="45" /></td>
						<td colspan="2" ><input type="text" class="expediente_tarjeta" size="35" /></td>
					</tr>
					<tr>
						...
						<td class="obligatorio texto_celda">&nbsp;Beneficio</td>
					</tr>
					<tr>
						...
						<td><input type="text" class="beneficio_tarjeta" size="35"/></td>
					</tr>
