...
session("usuario_directorio_activo") = Request.Form("ocultousuario_login")
session("usuario_directorio_activo_nombre") = Request.Form("ocultonombre_login")
session("usuario_directorio_activo_apellidos") = Request.Form("ocultoapellidos_login")
session("usuario_directorio_activo_grupo_empleado") = Request.Form("ocultogrupo_empleado_login")
session("usuario_directorio_activo_nuevo_empleado") = Request.Form("ocultonuevo_empleado_login")
session("usuario_directorio_activo_fecha_alta") = Request.Form("ocultofecha_alta_empleado_login")
session("usuario_directorio_activo_fecha_nuevo_verano") = Request.Form("ocultofecha_nuevo_verano_empleado_login")
session("usuario_directorio_activo_fecha_nuevo_invierno") = Request.Form("ocultofecha_nuevo_invierno_empleado_login")
...
function abrirArticulos(esAdmin, entorno) {
	...
	if (entorno=='REAL')
		{
	    var dir = 'http://carrito.globalia-artesgraficas.com/GAG_IMPRESORAS/'; // PROD --              
		}
	  else
	  	{
        ...
        location.href = dir+'Lista_Articulos_GAG_Empleados_GLS.asp'
