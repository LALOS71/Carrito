...
function validar(pedido_minimo, impresora_gls)
{
	...
	if (impresora_gls =='SI')
		...
		if (checkBox_manual.checked != true){
		    // Checkbox está marcado
			hay_error='SI'
			cadena_error+='<br>- Se ha de indicar que se ha leido el manual de gestión de las impresoras.'
			}
		}
													...
													<tr>
														<td colspan="3">
															...
															<label class="form-check-label" for="chkleido_manual_impresoras_gls">
																Leido el Manual de Gestión. Puede consultarlo <a href="../Documentacion/GLS/GLS_Manual_Gestion_Impresoras.pdf" target="_blank">Aqui.</a>
															</label>
