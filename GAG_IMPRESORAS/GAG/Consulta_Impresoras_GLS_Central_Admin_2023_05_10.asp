					...
					<div class="card">
						<div class="card-body">
							<div class="row mb-4">
								...
								%>
								<div class="col-12 text-center"><img class="img-responsive" src="Images/<%=nombre_logo%>" style="max-height:90px"/></div>
							</div>
									<%
						...
						<div class="card-body">
								<form class="form-horizontal" role="form" name="frmbusqueda" id="frmbusqueda" method="post" action="----">
									...
									<div class="form-group">
										<div class="col-sm-12 col-md-7 col-lg-7 autocomplete_txt">
...
//	if (typeof lst_impresoras == 'undefined') {
							...
							bootbox.dialog({
								...
								buttons: {
									...
									save: {
										...
										callback: function() {
											var seleccionado = $('#ocultocliente_nuevo').val();
											var cantidad = $('#cantidad').val();
											if (seleccionado === '' || cantidad === '') {
												bootbox.alert("Debe seleccionar un elemento y especificar una cantidad.");
												return false;
											}
			...
			$("#lista_impresoras").on("dblclick", "tr", function(e) {
				...
				var sn_impresora=$(this).closest('tr').find('td:eq(1)').text();
