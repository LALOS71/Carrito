			  		...
			  		<%if session("usuario_tipo")="GLS PROPIA" or empleado_gls="SI" then%>
						<div class="row"> 
							<div class="col-md-6">
								 <!--PEDIDOS REALIZADOS-->
								  <div class="panel panel-default">
									<div class="panel-heading"><b>Pedidos</b></div>
									<div class="panel-body">
										<div align="center" class="col-md-12">	
											<button type="button" id="cmdconsultar_pedidos" name="cmdconsultar_pedidos" class="btn btn-primary btn-sm">
													<i class="glyphicon glyphicon-search"></i>
							...
							<div class="col-md-6">
								<select class="form-control" name="cmbestados" id="cmbestados" size="1">
									...
									<%if session("usuario_codigo_empresa")=4 then
										...
										<%else
											'UVE y GENERAL CARRITO no tiene este estado, directamente Los pedidos van a sin tratar para UVE,
											' y a pendiente de pago en GENERAL CARRITO
											if session("usuario_codigo_empresa")<>150 AND session("usuario_codigo_empresa")<>260 then%>
												<option value="PENDIENTE AUTORIZACION">PENDIENTE AUTORIZACION</option>
											<%end if%>
									<%end if%>
										...
										<tbody> 
											...
											<%while not pedidos.eof%>
												...
												<tr valign="top">
													...
													<td width="113" valign="middle" onclick="mostrar_detalle(<%=pedidos("id")%>);"><%=pedidos("fecha")%></td>
