...
function validar(pedido_minimo)
{
	  	...
	  	<div class="panel panel-default">
			<div class="panel-body">
				<div align="center" class="col-md-12">	
					...
					<button type="button" id="cmdconfirmar" name="cmdconfirmar" class="btn btn-success btn-lg" onclick="validar('<%=pedido_minimo_permitido%>');return false">
