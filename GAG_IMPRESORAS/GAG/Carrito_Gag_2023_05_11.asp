...
'{"name":"oculto_pais_oficina","value":"ESPAÑA"},{"name":"txtnumero_empleado_d","value":"1234"},{"name":"txthorario_entrega_d","value":"45677"},
...
'{"name":"txtpais_oficina_d","value":"ESPAÑA"},{"name":"txtnif_d","value":"B37234184"},{"name":"txtrazon_social_d","value":"EL SECRETARIO, S.L."},{"name":"radio","value":"CLIENTE"},
'{"name":"txttelefono_d","value":"923 280 646"},{"name":"txtemail_d","value":""},{"name":"txtdomicilio_d","value":"NORBERTO CUESTA DUTARI, 5"},
'{"name":"txtpoblacion_d","value":"SALAMANCA"},{"name":"txtcp_d","value":"37007"},{"name":"txtprovincia_d","value":"SALAMANCA"},{"name":"txtpais_d","value":"ESPAÑA"},
...
function validar(pedido_minimo, impresora_gls)
{
	...
	if (<%=Session("numero_articulos")%>>0)
		...
		if ($("input:radio[name=optdireccion_envio]:checked").val()=='NUEVA')
			...
			if ($('#txtdestinatario_d').val()=='')
				{
				hay_error='SI'
				cadena_error+='<br>- Se Ha de Completar El Destinatario en la Dirección de Envío.'
				}

			if ($('#txttelefono_destinatario_d').val()=='')
				{
				hay_error='SI'
				cadena_error+='<br>- Se Ha de Completar El Tel&eacute;fono en la Dirección de Envío.'
				}
			
			if ($('#txtdireccion_destinatario_d').val()=='')
				{
				hay_error='SI'
				cadena_error+='<br>- Se Ha de Completar La Dirección en la Dirección de Envío.'
				}

			if ($('#txtpoblacion_destinatario_d').val()=='')
				{
				hay_error='SI'
				cadena_error+='<br>- Se Ha de Completar La Población en la Dirección de Envío.'
				}

			if ($('#txtcp_destinatario_d').val()=='')
				{
				hay_error='SI'
				cadena_error+='<br>- Se Ha de Completar El Código Postal en la Dirección de Envío.'
				}

			if ($('#txtprovincia_destinatario_d').val()=='')
				{
				hay_error='SI'
				cadena_error+='<br>- Se Ha de Completar La Provincia en la Dirección de Envío.'
				}

			if ($('#txtpais_destinatario_d').val()=='')
				{
				hay_error='SI'
				cadena_error+='<br>- Se Ha de Completar El País en la Dirección de Envío.'
				}
		...
		if (no_papeleria_propia=='SI' && si_papeleria_propia=='SI')
			{
			hay_error='SI'
			cadena_error+='<br>- No se pueden mezclar en el mismo pedido articulos de Papelería Propia con el resto de articulos.'
			}
		...
		<%if (session("usuario_codigo_empresa")=4) then%>		
			if (no_navidad=='SI' && si_navidad=='SI')
				{
				//10/11/2022 ya se pueden mezclar estos articulos
				//hay_error='SI'
			...
			if (no_rotulacion_gls=='SI' && si_rotulacion_gls=='SI')
				{
				hay_error='SI'
				cadena_error+='<br>- No se pueden mezclar en el mismo pedido articulos de Rotulación Interior o Exterior con el resto de articulos.'
				}
	...
	if (impresora_gls =='SI')
		{
		var checkBox = document.getElementById("chkcondidiones_impresoras_gls");
		if (checkBox.checked != true){
		    // Checkbox está marcado
			hay_error='SI'
			cadena_error+='<br>- Se han de aceptar las condiciones generales de cesión de las impresoras.'
			}
		}
...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9">
	  ...
	  <%if session("usuario_codigo_empresa")=4 and session("usuario_tipo")<>"GLS PROPIA" and empleado_gls<>"SI" then%>
			<!-- BOTONES PARA CONSULTAR PEDIDOS, DEVOLUCIONES Y SALDOS-->
			<div class="panel panel-default">
		        <div class="panel-body">
					<div class="col-lg-4" align="center">
						<button type="button" id="cmdconsultar_pedidos" name="cmdconsultar_pedidos" class="btn btn-primary btn-block">
							<div>
							  <span class="fas fa-box-open icono_boton"></span>
							  <span class="texto_boton">&nbsp;Consultar Pedidos</span>
							</div>
						</button>
					</div>
					<div class="col-lg-4" align="center">
						<button type="button" id="cmdconsultar_devoluciones" name="cmdconsultar_devoluciones" class="btn btn-primary btn-block">
								<div>
								  <span class="fa-layers fa-fw icono_boton">
									<span class="fas fa-reply"></span>
									<%if dinero_disponible_devoluciones<>0 then%>
										<span class="fa-layers-counter" style="background:Tomato">&nbsp;<%=dinero_disponible_devoluciones%>€&nbsp;</span>
									<%end if%>
								  </span>
					...
					<div class="col-lg-4" align="center">
						<button type="button" id="cmdconsultar_saldos" name="cmdconsultar_saldos" class="btn btn-primary btn-block">
								<div>
								  <span class="fa-layers fa-fw icono_boton">
									<i class="fas fa-money-bill-wave"></i>
									<%if dinero_disponible_saldos<>0 then%>
										<span class="fa-layers-counter" style="background:Tomato">&nbsp;<%=dinero_disponible_saldos%>€&nbsp;</span>
									<%end if%>
								  </span>
        ...
        <div class="panel-body">
							...
							<table class="table" id="tabla_datos"> 
								...
								<tbody> 
									...
									'para controlar los gastos de envio de groundforce, empresa codigo 30
										...
										<td  class="col-md-1">
											...
											if articulo_personalizado="SI" then%>
												...
												<%else
													...
													'end if
													'response.write("<br>tamaño arrai:" & (ubound(calculos_cantidades_precios)))
										...
										<%end if%>	
											...
											<tr id="fila_gastos_envio" style="display:none">
											  <td>&nbsp;
												...
												<!--
												<br />maletas_pequeñas: <%=maletas_pequennas%>
												...
												<!--<br />gasto maletas_medianas: -->
													...
													' y las pequeñas dentro de las medianas o grandes, 
													...
													'response.write("<br>(" & gastos_de_envio_total & ")")
													%>
													<!--<br />gasto maletas_pequeñas (dentro de medianas o grandes): -->
													<%
											  ...
											  <th style="text-align:right;color:#880000" id="celda_gastos_de_envio">
											  		<%
													'si es Grounforce, veo si hay gastos de envio...
													...
													<tr>
														<td colspan="3">
															...
															<label class="form-check-label" for="chkcondidiones_impresoras_gls">
																Aceptar Condiciones de Cesión de Las Impresoras. Puede consultarlas <a href="../Documentacion/GLS/GLS_Condiciones_Generales_Cesion_Impresoras.pdf" target="_blank">Aqui.</a>
															</label>
	 ...
	 if (session("usuario_codigo_empresa")=4 and session("usuario_tipo")="GLS PROPIA") _
	 	OR (session("usuario_codigo_empresa")=210) THEN
					...
					<div class="panel-body">
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
                          <div class="form-group row">
							...
							if session("usuario")=5089 or session("usuario")=7395 then%>
	  ...
	  <div class="panel panel-default" id="modos_de_pago">
					<div class="panel-body">
						<div align="center" class="col-md-12">	
							...
							<div class="col-md-6 col-lg-6">
								<!--
								<h4><font color="blue"><b>Por motivos de mantenimiento, la opción de pago por pasarela de pago estará deshabilitada hasta nuevo aviso.<br />Disculpen las molestias.</b></font></h4>
								-->
			...
			<div class="panel panel-danger" id="aviso_asm_transferencias">
				...
				<div class="panel-body">
					<font class="fontbold" style="color:#880000">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						Una vez confirmado el pedido, por favor realice una transferencia indicando el nombre de la base y el número de pedido a la siguiente cuenta de Unicaja:
						<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Código I.B.A.N.: ES54 2103 2200 1800 3001 1111
						<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Código B.I.C. Unicaja: UCJAES2M
						
						<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						Transcurridos 30 dias desde la confirmación del pedido sin recibir el pago correspondiente, se procederá a la cancelación automática del mismo.
						<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<!--fin aviso para ASM-->
	  	...
	  	<div class="panel panel-danger" id="aviso_general_transferencias">
				...
				<div class="panel-body">
					<font class="fontbold" style="color:#880000">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						Una vez confirmado el pedido, por favor realice una transferencia indicando el número de pedido a la siguiente cuenta de Unicaja:
						<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Código I.B.A.N.: ES54 2103 2200 1800 3001 1111
						<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Código B.I.C. Unicaja: UCJAES2M
...
//si está oculta la fila del gasto de envio, no tengo que aplicarlo en el total del pedido
if ( $("#fila_gastos_envio").css('display') == 'none' || $("#fila_gastos_envio").css("visibility") == "hidden")
	{
	...
	if ('<%=session("usuario_codigo_empresa")%>' == '30')
		...
		$(".oculto_articulo").each(function(index, element) 
			...
			if ((familia>=357) && (familia<=361))
				...
				//console.log('peso a añadir: ' + (peso * cantidad))
