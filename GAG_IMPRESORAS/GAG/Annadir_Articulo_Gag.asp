...
'response.write("<br>cantidades_precios: " & cantidades_precios)
...
if ya_existe="NO" then
	...
	'response.write("<br>Session(session('numero_articulos') '_cantidades_precios'): " & Session(session("numero_articulos") & "_cantidades_precios"))
  else
	...
	'response.write("<br>Session(valor_i_cambiar & '_cantidades_precios') " & Session(valor_i_cambiar & "_cantidades_precios"))
end if
...
<html>
<body>
&nbsp;<b><%=session("numero_articulos")%></b> <%=annadir_articulo_gag_literal_articulos%>
</body>
</html>