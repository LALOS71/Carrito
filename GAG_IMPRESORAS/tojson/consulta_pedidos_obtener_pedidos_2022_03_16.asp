...
<%
	...
	'response.write("<br>nombre establecimiento: " & nombre_establecimiento)
		...
		cadena_sql= cadena_sql & ", round( ((isnull(total,0 ) + isnull(gastos_envio,0) - isnull(total_devoluciones,0)) + ((isnull(total,0 ) + isnull(gastos_envio,0) - isnull(total_devoluciones,0)) * 0.21)), 2)  as TotalEnvio"
