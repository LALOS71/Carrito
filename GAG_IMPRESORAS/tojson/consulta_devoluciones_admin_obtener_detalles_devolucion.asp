...
<%
	...
	'response.write("<br>nombre establecimiento: " & nombre_establecimiento)
		...
		cadena_sql="SELECT B.CODIGO_SAP AS REFERENCIA, REPLACE(B.DESCRIPCION, '""', '____') as DESCRIPCION, A.CANTIDAD, A.TOTAL, A.ID_PEDIDO AS PEDIDO, A.ALBARAN, A.ID AS ID_DETALLE_DEVOLUCION, A.ID_DEVOLUCION"
	...
	cadena_resultado=REPLACE(cadena_resultado,"____", "\""")
