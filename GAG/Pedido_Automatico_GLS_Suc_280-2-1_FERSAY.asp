...
cadena_valores = sucursal_pedido & ", '" & DATE() & "', 'SIN TRATAR', '280-2-1 FERSAY', 'FERSAY', 'C/ Cobalto, 8 Pol. Ind. Los Hueros', 'Los Hueros (Villalbilla)', '28810', 'MADRID', 'ESPAÑA', NULL, NULL, NULL"
...
'ENVIAMOS EL CORREO ELECTRONICO
	...
	asunto = "(FERSAY) PEDIDO AUTOMATICO " & numero_pedido & " GLS Suc. 280-2-1 (" & date() & ")"
	...
	mensaje = mensaje & "Con fecha " & date() & " se ha generado de forma autom&aacute;tica el pedido " & numero_pedido & " (FERSAY) para la sucursal 280-2-1 COMERCIAL PLT."
...
<TITLE>Grabar Pedido AUTOMATICO GLS 280-2-1 COMERCIAL PLT - FERSAY</TITLE>
</HEAD>
