						...
						<div class="card-body">
								<form class="form-horizontal" role="form" name="frmbusqueda" id="frmbusqueda" method="post" action="----">
									...
									<div class="form-group row">    
										  <div class="col-md-3">
											<input type="text" class="form-control" name="txtsn_impresora" id="txtsn_impresora" value="" placeholder="Número de Serie"
													data-toggle="popover" 
													data-placement="bottom" 
													data-trigger="hover" 
										  ...
										  <div class="row col-3">
											  ...
											  <div class="col-6">
												<select id="cmbrenting" name="cmbrenting" class="form-control">
...
mostrar_impresoras = function (){
	...
	renting_seleccionado = '' + $("#cmbrenting").val()
	$.ajax({
        url: "Tabla_Impresoras_GLS_Central_Admin.asp",
