...
with empleados
	...
	'.Source=.Source & " AND ID IN (1851, 1852, 1853, 1854, 1855, 1856, 1857, 1858)"
...
<%
	...
	'sql = sql & "-------------------------------------------"
	sql = sql & " AND CONVERT(VARCHAR(8), X.FECHA, 112) >= CONVERT(VARCHAR(8), CONVERT(DATETIME, '01-10-2021', 103), 112)"
	sql = sql & " AND CONVERT(VARCHAR(8), X.FECHA, 112) <= CONVERT(VARCHAR(8), CONVERT(DATETIME, '31-12-2021', 103), 112)"
