								...
								<tbody> 
									...
									<tr >
										...
										<td class="col-md-3">
											...
											', 230 AVORIS, 240 FRANQUICIAS HALCON, 250 FRANQUICIAS ECUADOR, 260 GENERAL CARRITO, 280 HOSPES y 290 HOTEL CONDESA tampoco
											if session("usuario_codigo_empresa")<>4 AND session("usuario_codigo_empresa")<>150 _
												...
												and session("usuario_codigo_empresa")<>260 and session("usuario_codigo_empresa")<>280 and session("usuario_codigo_empresa")<>290 then%>		
