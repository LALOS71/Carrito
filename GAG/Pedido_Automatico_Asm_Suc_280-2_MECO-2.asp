...
cadena_valores = sucursal_pedido & ", '" & DATE() & "', 'SIN TRATAR', '280-2 MECO 2'"
...
'DMIS3968 NUEVO MULTISOBRE PEQUEÑO ASM , codigo de articulo 600 , 72 unidades 
...
'DMIS3067 NUEVO MULTISOBRE MEDIANO ASM, codigo de articulo 582, 90 unidades de pedido.
...
'DMIS3067PL NUEVO MULTISOBRE MEDIANO ASM PACKING LIST, codigo de articulo 2127, 40 unidades 
...
adParamInput=1
		...
		cmd.parameters("P_ASUNTO")= cadena_asunto & "(MECO 2) PEDIDO AUTOMATICO " & numero_pedido & " ASM Suc. 280-2 (" & date() & ")"
		
		mensaje="Con fecha " & date() & " se ha generado de forma autom&aacute;tica el pedido " & numero_pedido & " para la sucursal 280-2 (MECO 2) de ASM"
...
<TITLE>Grabar Pedido AUTOMATICO ASM 280-2 MECO 2</TITLE>
</HEAD>
