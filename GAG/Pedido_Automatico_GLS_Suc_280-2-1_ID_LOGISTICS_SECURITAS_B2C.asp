...
cadena_valores = sucursal_pedido & ", '" & DATE() & "', 'SIN TRATAR', '280-2-1 ID LOGISTICS SECURITAS B2C', 'ID LOGISTICS SECURITAS B2C', 'C/CAMINO DE ALOVERA, 4 Y 6 POL. IND. LA QUINTA', 'MADRID', '28071', 'MADRID', 'ESPAÑA', 'STEPHANIE MOJICA Y MARIA CANO', '610359095', NULL"
...
'NLOP001ECOP MULTISOBRE ESTANDAR PEQUEÑO 100% RECICLADO, codigo de articulo 4550, 750 unidades
...
'ENVIAMOS EL CORREO ELECTRONICO
	...
	asunto = "(ID LOGISTICS SECURITAS B2C) PEDIDO AUTOMATICO " & numero_pedido & " GLS Suc. 280-2-1 (" & date() & ")"
	...
	mensaje = mensaje & "Con fecha " & date() & " se ha generado de forma autom&aacute;tica el pedido " & numero_pedido & " (ID LOGISTICS SECURITAS B2C) para la sucursal 280-2-1 COMERCIAL PLT."
...
<TITLE>Grabar Pedido AUTOMATICO GLS 280-2-1 COMERCIAL PLT - ID LOGISTICS SECURITAS B2C</TITLE>
</HEAD>
