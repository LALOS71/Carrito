...
with empleados
	...
	.Source="SELECT * FROM EMPLEADOS_GLS"
...
<%
	...
	'sql = sql & "-------------------------------------------"
	sql = sql & " AND CONVERT(VARCHAR(8), X.FECHA, 112) >= CONVERT(VARCHAR(8), CONVERT(DATETIME, '01-10-2020', 103), 112)"
	sql = sql & " AND CONVERT(VARCHAR(8), X.FECHA, 112) <= CONVERT(VARCHAR(8), CONVERT(DATETIME, '31-03-2021', 103), 112)"
	...
	'------------------------------
	'inicio condicion fecha limite
	'-------------------------------------
	sql = sql & " AND CONVERT(VARCHAR(8), FECHA_ACEPTACION, 112) >= CONVERT(VARCHAR(8), CONVERT(DATETIME, '01-10-2020', 103), 112)"
	sql = sql & " AND CONVERT(VARCHAR(8), FECHA_ACEPTACION, 112) <= CONVERT(VARCHAR(8), CONVERT(DATETIME, '31-03-2021', 103), 112)"
	...
	'-------------------------------------------------
	'final de la condicion de la fecha limite
	'------------------------------------------
