...
cadena_valores = sucursal_pedido & ", '" & DATE() & "', 'SIN TRATAR', '280-2 EUROLOGISTICA', 'INTERBOX EUROLOGISTICA (Att.: Andra)', 'Avd. del Rio Henares, 38', 'Alovera', '19208', 'Guadalajara', '911 33 48 76'"
...
'RBOP001P MULTISOBRE GLS ESTANDAR PEQUEÑO, codigo de articulo 2683, 1000 unidades
'hay una nueva linea de productos por el nuevo logo de GLS
'NLOP001P MULTISOBRE GLS ESTANDAR PEQUEÑO, codigo de articulo 3670, 1000 unidades
'se cambia por la gama ECO
'NLOP001ECOP MULTISOBRE GLS ESTANDAR PEQUEÑO 100% RECICLADO, codigo de articulo 4550, 1000 unidades
...
'RBOPE0702 ETIQUETA TERMICA ZIGZAG  , codigo de articulo 580 , 100 unidades
...
' ya no se mandan 02/12/2020
'RBOP001M	MULTISOBRE GLS ESTANDAR MEDIANO, codigo de articulo 2684, 500 unidades
'hay una nueva linea de productos por el nuevo logo de GLS
'NLOP001M	MULTISOBRE GLS ESTANDAR MEDIANO, codigo de articulo 3667, 500 unidades
...
'RPOPE0501	SOBRE CANGURO DAC GLS, codigo de articulo 2896, 20 unidades
'hay una nueva linea de productos por el nuevo logo de GLS
'NLOPE0501	SOBRE CANGURO DAC GLS, codigo de articulo 3512, 20 unidades
...
'ENVIAMOS EL CORREO ELECTRONICO
	...
	asunto = "(EUROLOGISTICA) PEDIDO AUTOMATICO " & numero_pedido & " GLS Suc. 280-2 (" & date() & ")"
	...
	mensaje = mensaje & "Con fecha " & date() & " se ha generado de forma autom&aacute;tica el pedido " & numero_pedido & " para la sucursal 280-2 (EUROLOGISTICA) de GLS."
...
<TITLE>Grabar Pedido AUTOMATICO ASM 280-2 EUROLOGISTICA</TITLE>
</HEAD>
