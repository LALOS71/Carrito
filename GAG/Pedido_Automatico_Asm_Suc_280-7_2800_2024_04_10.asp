...
cadena_campos = "CODCLI, FECHA, ESTADO, PEDIDO_AUTOMATICO, DESTINATARIO, DESTINATARIO_DIRECCION, DESTINATARIO_POBLACION, DESTINATARIO_CP, DESTINATARIO_PROVINCIA, DESTINATARIO_PAIS, DESTINATARIO_PERSONA_CONTACTO, DESTINATARIO_TELEFONO, DESTINATARIO_COMENTARIOS_ENTREGA"
cadena_valores = sucursal_pedido & ", '" & DATE() & "', 'SIN TRATAR', '280-7 2800', 'GLS HUB MADRID', 'INGENIERO TORRES QUEVEDO, 1', 'MADRID', '28072', 'MADRID', 'ESPAÑA', 'MARY LUZ', '699206715', 'HUB_MADRID'"
...
'RPOPE0604 BRIDA ROJA CIERRE SACA, codigo de articulo 702, 400 unidades
codigo_articulo_pedido=702
cantidad_pedida=400
...
'de momento no se mandan bridas hasta nuevo aviso
'connimprenta.Execute cadena_ejecucion,,adCmdText + adExecuteNoRecords


'....esté articulo hasta nueva orden, no se añade al pedido, lo quitamos
'NLPRE2800 PRECINTO 2800 MADRID, codigo de articulo 4653, 500 unidades
codigo_articulo_pedido=4653
cantidad_pedida=500
...
'ENVIAMOS EL CORREO ELECTRONICO
	...
	asunto = "(2800) PEDIDO AUTOMATICO " & numero_pedido & " GLS Suc. 280-7 (" & date() & ")"
	...
	mensaje = mensaje & "Con fecha " & date() & " se ha generado de forma autom&aacute;tica el pedido " & numero_pedido & " (2800) para la sucursal 280-7 GENERACION DE ENVIOS de GLS."
...
<TITLE>Grabar Pedido AUTOMATICO GLS 280-7 2800 GENERACION DE ENVIOS</TITLE>
</HEAD>
