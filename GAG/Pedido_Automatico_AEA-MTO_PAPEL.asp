...
'AIR EUROPA MTO-SECRETARIA (MTO) ------ 5261
sucursal_pedido=5261 


'Datos de la cabecera del Pedido
cadena_campos = "CODCLI, FECHA, ESTADO, PEDIDO_AUTOMATICO"
cadena_valores = sucursal_pedido & ", '" & DATE() & "', 'SIN TRATAR', 'AEA MTO PAPEL'"
...
'B030002 PAPEL A4 75GR OCEAN (500H), codigo de articulo 1396, 20 unidades
codigo_articulo_pedido=1396
cantidad_pedida=20
...
adParamInput=1
		...
		if Request.ServerVariables("SERVER_NAME")<>"carrito.globalia-artesgraficas.com" then
			...
			'ENTORNO REAL
			correos_recibe="carlos.gonzalez@globalia-artesgraficas.com; fidel.fonseca@globalia-artesgraficas.com; plopez@globalia.com; malba@halconviajes.com" 		  	
			cadena_asunto=""
		end if
		'response.write("<br>" & Request.ServerVariables("SERVER_NAME"))
		cmd.parameters("P_RECIBE")=correos_recibe
		cmd.parameters("P_ASUNTO")= cadena_asunto & "(AEA MTO PAPEL) PEDIDO AUTOMATICO " & numero_pedido & " AIR EUROPA Suc. MTO (" & date() & ")"
		
		mensaje="Con fecha " & date() & " se ha generado de forma autom&aacute;tica el pedido " & numero_pedido & " para la sucursal MTO (AEA MTO PAPEL) de AIR EUROPA"
...
<TITLE>Grabar Pedido AUTOMATICO AEA MTO PAPEL</TITLE>
</HEAD>
