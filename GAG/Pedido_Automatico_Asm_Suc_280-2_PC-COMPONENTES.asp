...
cadena_valores = sucursal_pedido & ", '" & DATE() & "', 'SIN TRATAR', '280-2 PC-COMPONENTES', 'PC COMPONENTES', 'AVD. EUROPA P.I. LAS SALINAS, PARC. 2-5 / 2-6', 'ALHAMA DE MURCIA', '30998', 'MURCIA'"
...
'RBOPE0703A	ETIQUETA TERMICA ROLLO ( CAJA DE 860 UND. ), codigo de articulo 3720, 47 unidades (para que se aproxime a las 40.000 unidades que se envian con el articulo antiguo)
...
mes=month(date())
anno=year(date())
'response.write("<br>mes: " & mes & " año: " & anno)
mes70="NO"
anno70="NO"
...
if mes70="SI" and anno70="SI" then
	cantidad_pedida=70
end if
...
'ENVIAMOS EL CORREO ELECTRONICO
	...
	asunto = "(PC-COMPONENTES) PEDIDO AUTOMATICO " & numero_pedido & " GLS Suc. 280-2 (" & date() & ")"
	...
	mensaje = mensaje & "Con fecha " & date() & " se ha generado de forma autom&aacute;tica el pedido " & numero_pedido & " para la sucursal 280-2 (PC-COMPONENTES) de GLS."
...
<TITLE>Grabar Pedido AUTOMATICO ASM 280-2 PC-COMPONENTES</TITLE>
</HEAD>
