...
cadena_valores = sucursal_pedido & ", '" & DATE() & "', 'SIN TRATAR', '280-2 INGRAM', 'INGRAM MICROSERVICES SPAIN (At.: Sergio Sánchez)', 'C/ Plástico, S/N. P.I. Miralcampo', 'MADRID', '28071', 'MADRID'"
...
'RBOPE0703 ETIQUETA TERMICA ROLLO, codigo de articulo 581, 30 unidades
'RBOP001M MULTISOBRE GLS ESTANDAR MEDIANO, codigo de articulo 2684, 5 unidades
'hay una nueva linea de productos por el nuevo logo de GLS
'NLOP001M MULTISOBRE GLS ESTANDAR MEDIANO, codigo de articulo 3667, 5 unidades
'se cambia a la gama ECO
'NLOP001ECOM MULTISOBRE GLS ESTANDAR MEDIANO 100% RECICLADO, codigo de articulo 4551, 5 unidades
...
'ENVIAMOS EL CORREO ELECTRONICO
	...
	asunto = "(INGRAM) PEDIDO AUTOMATICO " & numero_pedido & " GLS Suc. 280-2 (" & date() & ")"
	...
	mensaje = mensaje & "Con fecha " & date() & " se ha generado de forma autom&aacute;tica el pedido " & numero_pedido & " para la sucursal 280-2 (INGRAM) de GLS."
...
<TITLE>Grabar Pedido AUTOMATICO GLS 280-2 INGRAM</TITLE>
</HEAD>
