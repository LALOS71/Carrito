...
cadena_valores = sucursal_pedido & ", '" & DATE() & "', 'SIN TRATAR', '280-2 DOSFARMA', 'DOSFARMA', 'Avd. Gerardo Molina, 117', 'Torre-Pacheco', '30998', 'MURCIA'"
...
'RBOPE0703 ETIQUETA TERMICA ROLLO, codigo de articulo 581, 40 unidades
...
adParamInput=1
		...
		cmd.parameters("P_ASUNTO")= cadena_asunto & "(DOSFARMA) PEDIDO AUTOMATICO " & numero_pedido & " GLS Suc. 280-2 (" & date() & ")"
		
		mensaje="Con fecha " & date() & " se ha generado de forma autom&aacute;tica el pedido " & numero_pedido & " para la sucursal 280-2 (DOSFARMA) de GLS"
