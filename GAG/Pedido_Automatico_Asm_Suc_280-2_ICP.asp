...
cadena_valores = sucursal_pedido & ", '" & DATE() & "', 'SIN TRATAR', '280-2 ICP'"
...
cadena_valores = sucursal_pedido & ", '" & DATE() & "', 'SIN TRATAR', '280-2 ICP', 'ICP LOGÍSTICA (Att. CAROLINA GARCÍA)', 'C/ MARTE, 40', 'MECO', '28070', 'MADRID'"
...
'DMIS3067 NUEVO MULTISOBRE MEDIANO ASM  , codigo de articulo 582 , 750 unidades 
codigo_articulo_pedido=582
cantidad_pedida=750
...
'DMIS3067PL NUEVO MULTISOBRE MEDIANO ASM PACKING LIST, codigo de articulo 2127, 250 unidades 
codigo_articulo_pedido=2127
cantidad_pedida=250
...
'DMIS3076 NUEVO MULTISOBRE GRANDE ASM, codigo de articulo 703, 180 unidades 
codigo_articulo_pedido=703
cantidad_pedida=180
...
'DMIS3968V MULTISOBRE PEQUEÑO CON VERIFICACIÓN DNI, codigo de articulo 2618, 60 unidades
codigo_articulo_pedido=2618
cantidad_pedida=60
...
'DMIS3968 NUEVO MULTISOBRE PEQUEÑO ASM  , codigo de articulo 600 , 400 unidades
codigo_articulo_pedido=600
cantidad_pedida=400
...
adParamInput=1
		...
		cmd.parameters("P_ASUNTO")= cadena_asunto & "(ICP) PEDIDO AUTOMATICO " & numero_pedido & " ASM Suc. 280-2 (" & date() & ")"
		
		mensaje="Con fecha " & date() & " se ha generado de forma autom&aacute;tica el pedido " & numero_pedido & " para la sucursal 280-2 (ICP) de ASM"
...
<TITLE>Grabar Pedido AUTOMATICO ASM 280-2 ICP</TITLE>
</HEAD>
