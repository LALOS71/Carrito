					...
					<form name="frmbuscar_hojas_ruta" id="frmbuscar_hojas_ruta" method="post" action="">	
						...
						<div class="row  mx-2">
							 <table id="lista_presupuestos" name="lista_presupuestos" class="table table-striped table-bordered" cellspacing="0" width="99%">
							  <thead>
								<tr>
								  <th class="w-5">Presupuesto</th>
								  <th class="w-15">Estado</th>
								  <th class="w-20">Cliente</th>
								  <th class="w-15">Presupuestista</th>
								  <th class="w-30">Descripci&oacute;n</th>
								  <th class="w-5">Fecha de creaci&oacute;n</th>		
								  <th class="w-5">Cantidad</th>
								  <th class="w-5">Importe</th>
								</tr>
							  </thead>
							</table>
            			</div>    
        ...
        source: {
            cliente: {
                ...
                ajax: function (query) {
                    return {
                        type: "POST",
                        url: "tojson/obtener_clientes_graphisoft.asp",
...
consultar_hojas_ruta = function () {
    ...
    if (typeof lst_presupuesto == "undefined") {
        ...
        j$("#lista_presupuestos").on("dblclick", "tr", function (e) {
            ...
            mostrar_detalle_hoja_ruta(parametro_presupuesto)
        });
        ...
        j$('#lista_presupuestos').on('click', '.boton_guardar_estado', function () {
            ...
            parametro_presupuesto = row.HOJA_DE_RUTA.replace(' ', '')
            ...
            console.log('LOS VALORES A GUARDAR SON: HOJA DE RUTA.... ' + parametro_presupuesto + ' ... ESTADO... ' + parametro_id_estado_nuevo)
            ...
            if (controles_visibles > 1) {
                ...
                j$.ajax({
                    ...
                    data: {
                        hoja_de_ruta: parametro_presupuesto,
...
mostrar_detalle_hoja_ruta = function (parametro_presupuesto) {
