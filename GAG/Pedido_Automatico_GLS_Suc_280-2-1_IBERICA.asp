...
cadena_valores = sucursal_pedido & ", '" & DATE() & "', 'SIN TRATAR', '280-2-1 IBERICA', 'GLS CIM VALLES', 'C/H Nº85-86, Nave 11, CIM Vallès', 'Santa Perpetua de Mogoda', '08130', 'BARCELONA', 'ESPAÑA', 'PAU MARTIN', '931780702', 'IBERICA DISTRIB.ONLINE DEL HOGAR'"
...
'RBOPE0702 ETIQUETA TERMICA ZIGZAG, codigo de articulo 580, 30 unidades
...
'ENVIAMOS EL CORREO ELECTRONICO
	...
	asunto = "(IBERICA) PEDIDO AUTOMATICO " & numero_pedido & " GLS Suc. 280-2-1 (" & date() & ")"
	...
	mensaje = mensaje & "Con fecha " & date() & " se ha generado de forma autom&aacute;tica el pedido " & numero_pedido & " (IBERICA) para la sucursal 280-2-1 COMERCIAL PLT."
...
<TITLE>Grabar Pedido AUTOMATICO GLS 280-2-1 IBERICA COMERCIAL PLT</TITLE>
</HEAD>
