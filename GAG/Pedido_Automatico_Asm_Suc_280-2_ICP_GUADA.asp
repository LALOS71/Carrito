...
cadena_valores = sucursal_pedido & ", '" & DATE() & "', 'SIN TRATAR', '280-2 ICP GUADA', 'ICP GUADA', 'C/ CAMINO DE LA VEGA, 1', 'CHILOECHES', '19160', 'GUADALAJARA'"
...
'DMIS3968 NUEVO MULTISOBRE PEQUEÑO ASM, codigo de articulos 600, 20 unidades 
...
'DMIS3969 NUEVO MULTISOBRE SEMI GRANDE ASM , codigo de articulo 884, 10 unidades 
codigo_articulo_pedido=884
cantidad_pedida=10
...
'DMIS3067 NUEVO MULTISOBRE MEDIANO ASM, codigo de articulo 582, 30 unidades 
...
'DMIS3067PL NUEVO MULTISOBRE MEDIANO ASM PACKING LIST, codigo de articulo 2127, 10 unidades
...
adParamInput=1
		...
		cmd.parameters("P_ASUNTO")= cadena_asunto & "(ICP GUADA) PEDIDO AUTOMATICO " & numero_pedido & " ASM Suc. 280-2 (" & date() & ")"
		
		mensaje="Con fecha " & date() & " se ha generado de forma autom&aacute;tica el pedido " & numero_pedido & " para la sucursal 280-2 (ICP GUADA) de ASM"
