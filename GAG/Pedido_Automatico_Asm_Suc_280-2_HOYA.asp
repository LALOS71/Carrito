...
cadena_valores = sucursal_pedido & ", '" & DATE() & "', 'SIN TRATAR', '280-2 HOYA'"
...
'RBOP001MBR MULTISOBRE ESTANDAR MEDIANO COD. BARRAS, codigo de articulo 2936, 30 unidades
codigo_articulo_pedido=2936
cantidad_pedida=30
...
adParamInput=1
		...
		cmd.parameters("P_ASUNTO")= cadena_asunto & "(HOYA) PEDIDO AUTOMATICO " & numero_pedido & " ASM Suc. 280-2 (" & date() & ")"
		
		mensaje="Con fecha " & date() & " se ha generado de forma autom&aacute;tica el pedido " & numero_pedido & " para la sucursal 280-2 (HOYA) de ASM"
