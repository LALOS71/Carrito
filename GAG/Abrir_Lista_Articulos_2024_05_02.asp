...
function verpopup_2(esAdmin, entorno, empresa){
...
<BODY onload="verpopup('<%=administrador_central%>', '<%=entorno_servidor%>', <%=session("usuario_codigo_empresa")%>)">
<!--
<BODY onload="verpopup_2('<%=administrador_central%>', '<%=entorno_servidor%>', <%=session("usuario_codigo_empresa")%>)">
-->
<!--
