...
cadena_valores = sucursal_pedido & ", '" & DATE() & "', 'SIN TRATAR', '280-2 NORBERT', 'INTERBOX EUROLOGISTICA', 'COMPLEJO LOGÍSTICO NORBERT DENTRESSANGLE', 'MADRID', '28070', 'MADRID'"
...
'RBOPE0702 ETIQUETA TERMICA ZIGZAG  , codigo de articulo 580 , 150 unidades
...
'RBOP001P MULTISOBRE GLS ESTANDAR PEQUEÑO, codigo de articulo 2683, 130 unidades
 

codigo_articulo_pedido=2683
cantidad_pedida=130
...
adParamInput=1
		...
		cmd.parameters("P_ASUNTO")= cadena_asunto & "(NORBERT) PEDIDO AUTOMATICO " & numero_pedido & " ASM Suc. 280-2 (" & date() & ")"
		
		mensaje="Con fecha " & date() & " se ha generado de forma autom&aacute;tica el pedido " & numero_pedido & " para la sucursal 280-2 (NORBERT) de ASM"
