...
<% 
	...
	'OpenFileobj.WriteLine("DENTRO DE PASARELA.ASP")
	
	'OpenFileobj.WriteBlankLines(4)
	'OpenFileobj.WriteLine("DETALLES TARJETA: " & detalles_tarjeta)
	'OpenFileobj.WriteLine("IMPORTE: " & importe)
	'OpenFileobj.WriteLine("OCULTOIMPORTE: " & Request.Form("ocultoimporte"))
	'OpenFileobj.WriteLine("CDBL IMPORTE: " & Cdbl(importe))
	'OpenFileobj.WriteLine("CDBL IMPORTE * 100: " & (Cdbl(importe) * 100))
	'OpenFileobj.WriteLine("AMOUNT: " & amount)
	...
	'OpenFileobj.WriteBlankLines(4)
	'OpenFileobj.WriteLine("CADENA SQL: " & cadena_ejecucion) 
