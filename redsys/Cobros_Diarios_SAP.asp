...
'https://docs.microsoft.com/es-es/windows/desktop/WinHttp/using-the-winhttprequest-com-object
	...
	if cuerpo_mensaje<>"" then
		...
		'hacemos el envio de email
		
		de = "carlos.gonzalez@globalia-artesgraficas.com"
		para = "malba@globalia-artesgraficas.com;ccalvo@globalia-artesgraficas.com" 		  	
		asunto = "Transacciones de Pago Enviadas a SAP (" & enviados & ") (" & date() & ")"
		if cuerpo_mensaje_error<>"" then
			asunto= asunto & " -- CON ERRORES"
		end if
...
response.write("<br>RESPUESTA DEL ENVIO DE EMAIL: " & respuesta_envio)
