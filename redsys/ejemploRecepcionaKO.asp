...
<html lang="es">
<head>
	<title>El Pago NO se Ha Podido Realizar</title>
</head>
<body>
<%
...
<div style="background-color:#fff;width:650px;font-family:Open-sans,sans-serif;color:#555454;font-size:13px;line-height:18px;margin:auto">
	<table style="width:100%" bgcolor="#ffffff">
		...
		<span><font color="red">Se ha producido un error al realizar la transacción del pago del pedido.</font></span>
		<br/>
		<br/>
		<span>Puede volver a intentar realizar el pago con tarjeta accediendo de nuevo al pedido desde la sección "Consultar Pedidos".</span>
		</font>
		</td>
		</tr>
		<tr><td style="padding:0!important">&nbsp;</td></tr>
