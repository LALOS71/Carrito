        ...
        (function(h, g, c, j, e, l, k) { /*! Jssor */
            ...
            var b = new function() {
                ...
                function Ib() {
                    if (!G) {
                        G = {
                            ze: "ontouchstart" in h || "createTouch" in g
                        };
                        var a;
                ...
                function Y(a) {
                    a.constructor === Y.caller && a.Ld && a.Ld.apply(a, Y.caller.arguments)
                }
                d.Ld = Y;
                d.Lb = function(a) {
                    if (d.Oe(a)) a = g.getElementById(a);
                    return a
                };
                ...
                function M(d, a) {
                    ...
                    if (a) {
                        ...
                        if (J()) {
                            if (a.ob || a.xb || a.db) c += " translate3d(" + (a.ob || 0) + "px," + (a.xb || 0) + "px," + (a.db || 0) + "px)";
                            if (a.C == k) a.C = 1;
                            if (a.D == k) a.D = 1;
                ...
                d.id = m("transformOrigin", 4);
                d.Ne = m("backfaceVisibility", 4);
                d.Pe = m("transformStyle", 4);
                ...
                d.Dd = function(a) {
                    ...
                    if (a)
                        ...
                        else if (b.dd(a.k)) c.k = {
                        Dc: a.k
                    };
                    return c
                };
                d.ud = function(l, m, x, q, z, A, n) {
                    var a = m;
                    if (l) {
                        a = {};
                        for (var g in m) {
                    ...
                    if (a.k && b.vf() && !a.k.g && !a.k.c && !a.k.K && !a.k.G && a.k.E == n.tb && a.k.F == n.qb) a.k = j;
                    return a
                }
            };
            ...
            var o = new function() {
                    ...
                    h.Wb = function(f) {
                        for (var d = f.q, e = f.B, s = f.jc, t = f.ve, r = [], a = 0, b = 0, p = d - 1, q = e - 1, h = t - 1, c, b = 0; b < e; b++)
                            for (a = 0; a < d; a++) {
                                switch (s) {
                                    case j:
                                        c = h - (a * e + (q - b));
                    ...
                    function i(g, d) {
                        ...
                        a.ae = function(c, b) {
                            ...
                            if (!a.Qb[f]) {
                                ...
                                for (var d = 0; d < a.q; d++)
                                    for (var e = 0; e < a.B; e++) a.Qb[f][e + "," + d] = {
                                        g: e * b,
                                        E: d * c + c,
                                        F: e * b + b,
                                        c: d * c
                    ...
                    function p(B, h, a, w, o, m) {
                        ...
                        if (b.sb()) {
                            var E = !h["no-image"],
                                A = b.If(h);
                            b.m(A, function(a) {
                                (E || a["jssor-slider"]) && b.Bb(a, b.Bb(a), e)
                            })
                        }
                        b.m(p, function(h, j) {
                            b.m(h, function(G) {
                                ...
                                i[t].rf = A + F - 1;
                                for (var z = 0; z <= F; z++) {
                                    var y = b.ud(f, s, z / F, a.e, a.nb, a.S, {
                                        vb: a.vb,
                                        tb: o,
                                        qb: m
                                    });
                ...
                i = function(o, fc) {
                    ...
                    function xc(o, g) {
                        ...
                        function E(a) {
                            ...
                            T(o, a, 0);
                            F = e;
                            q = new I.X(o, I, b.te(b.s(o, "idle")) || lc);
                            q.lb(0)
                        }
                            ...
                            if (!G) {
                                ...
                                if (k && o) {
                                    var h = o.width,
                                        ...
                                        m = c;
                                    if (h && c && a.pb) {
                                        if (a.pb & 3 && (!(a.pb & 4) || h > K || c > J)) {
                                            var j = l,
                                                q = K / J * c / h;
                                            if (a.pb & 1) j = q > 1;
                                            else if (a.pb & 2) j = q < 1;
                                            n = j ? h * J / c : K;
                                            m = j ? J : c * K / h
                                        }
                                        b.v(k, n);
                    ...
                    function vc(y, g, p, q) {
                        ...
                        a.Ze = function() {
                            A && A.rb == g && A.Gb();
                            var b = a.Mb();
                            b < c && d.r(i.Kc, g, -b - 1, n, j, f, c)
                        };
                        a.wd = function(a) {
                            p && b.Ab(lb, a && p.Qc.vd ? "" : "hidden")
                        };
                        a.Ac = function(b, a) {
                            if (k && a >= h) {
                                k = l;
                    ...
                    if (r) {
                        ...
                        if (mb) {
                            cc = mb.Rf;
                            rb = mb.X;
                            ib = u == 1 && r > 1 && rb && (!b.Fd() || b.Hd() >= 8)
                        }
                        kb = ib || u >= r || !(D & 1) ? 0 : a.Xc;
                        X = (u > 1 || kb ? fb : -1) & a.Pc;
                        var Gb = v,
                            C = [],
                            A, L, Db = b.Be(),
                            ob = Db.ze,
                            G, qb, Ib, sb;
                        Db.pd && b.jb(Gb, Db.pd, ([j, "pan-y", "pan-x", "none"])[X] || "");
                        U = new zc;
                        ...
                        Eb(W());
                        b.j(v, "click", jc, e);
                        b.j(o, "mouseout", b.pc(hc, o));
                        b.j(o, "mouseover", b.pc(Ec, o));
                        xb();
                        a.vc && b.j(g, "keydown", function(b) {
                            if (b.keyCode == 37) ab(-a.vc);
                            else b.keyCode == 39 && ab(a.vc)
                        });
                        var pb = a.fc;
            ...
            var p = {
                ...
                r = function(d, C) {
                    ...
                    f.tc = function(D) {
                        if (!u) {
                            ...
                            for (var f = 0; f < s; f++) {
                                var C = b.Af();
                                b.Rc(C, f + 1);
                                var l = b.ne(g, "numbertemplate", C, e);
                                b.H(l, "absolute");
                                var v = f % (n + 1);
                                b.Y(l, !h ? p * v : f % i * p);
                                ...
                                b.O(d, l);
                                B[f] = l;
                                a.zc & 1 && b.j(l, "click", b.T(j, t, f));
                                a.zc & 2 && b.j(l, "mouseover", b.pc(b.T(j, t, f), l));
                                y[f] = b.ic(l)
                            }
                            u = e
                        }
                    ...
                    x = a.hd;
                    h = a.Id - 1;
                    a.lc == l && b.L(d, "noscale", e);
                    a.Nb && b.L(d, "autocenter", a.Nb)
                },
                t = function(a, g, h) {
                    var c = this;
                    n.call(c);
                    ...
                    if (f.Nb) {
                        b.L(a, "autocenter", f.Nb);
                        b.L(g, "autocenter", f.Nb)
                    }
                };
