						...
						<div class="form-group row mx-2">
							...
							<div class="col-sm-3 col-md-3 col-lg-3">
								<button type="button" class="btn btn-primary btn-block" id="cmdresetear" name="cmdresetear"
									...
									data-placement="top"
									data-trigger="hover"
									data-content="Resetear Contrase�a del Empleado"
									data-original-title=""
									disabled>
									<i class="fas fa-sync-alt"></i>&nbsp;&nbsp;&nbsp;Resetear Contrase�a
								</button>
							</div>
				...
				callback: function (result) {
					...
					if (result)
						...
						if (resultado == false) 
							...
							cadena_mensaje+='<br>Pulse <b>"GUARDAR"</b> si est� seguro que el documento (DNI/CIF/NIF/NIE) est� correctamente escrito, y se guardar�n los datos.<br>'
			...
			function (data) {
				switch (data.resultado) {
					case 'OK':  
						bootbox.alert({
								size: 'large'
								, message: '<h3>Contrase�a del Empleado Reseteada...</h3><br><br><h5>Su usuario ser� su DNI, y su contrase�a, para el primer acceso ser� su DNI y al acceder el sistema le obligar� a cambiar la contrase�a por otra de su eleccion a la que no tendremos acceso.</h5>'
								, callback: function () {
			...
			function (data) {
				...
				switch (data.resultado) {
					case 'ALTA_OK':  
						bootbox.alert({
								size: 'large'
								, message: '<h3>Empleado Creado con Exito...</h3><br><br><h5>Su usuario ser� su DNI, y su contrase�a, para el primer acceso ser� su DNI y al acceder el sistema le obligar� a cambiar la contrase�a por otra de su eleccion a la que no tendremos acceso.</h5>'
								, callback: function () {
											/*
											j$("#ocultoid_empleado").val('')
											j$("#txtnif").val('')
					...
					case 'ALTA_DNI_REPETIDO':  
						bootbox.alert({
								size: 'large',
								message: '<h3 style="color:red">DNI Repetido...</h3><br><br><h5 style="color:red">El DNI introducido ya est� dado de alta en el sistema, aseg�rese que es correcto, y si es asi, busque al empleado desde La Busqueda de Empleado y modifique sus datos existentes en vez de crear un empleado nuevo.</h5>'
							});  
						break;
					...
					case 'MODIFICACION_DNI_REPETIDO':  
						bootbox.alert({
								size: 'large',
								message: '<h3 style="color:red">DNI Repetido...</h3><br><br><h5 style="color:red">El DNI introducido ya est� dado de alta en el sistema para otro Empleado, aseg�rese que es correcto, y si es asi, busque al empleado desde La Busqueda de Empleado y modifique sus datos existentes.</h5>'
							});  
						break;
...
function validarNIF(nif) {
    ...
    /*        
        ...
        Los DNI espa�oles pueden ser:
        NIF (Numero de Identificaci�n Fiscal) - 8 numeros y una letra1
        NIE (Numero de Identificaci�n de Extranjeros) - 1 letra2, 7 numeros y 1 letra1
