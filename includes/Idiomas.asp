...
Select Case lcase(session("idioma"))
	...
	case "en" 'para poner los literales en INGLES
			select case lcase(nombre) 'cada pagina carga su fichero de constantes
				...
				<%case "lista_articulos_gag_empleados_gls"%> <!--#include virtual="/includes/Lista_Articulos_Gag_Empleados_GLS_cons_en.asp"-->
				...
				<%case "plantilla_personalizacion_rotulacion"%> <!--#include virtual="/includes/Plantilla_Personalizacion_Rotulacion_cons_en.asp"-->
				<%case "plantilla_personalizacion_rotulacion_3"%> <!--#include virtual="/includes/Plantilla_Personalizacion_Rotulacion_3_cons_en.asp"-->
				<%case "plantilla_personalizacion_rotulacion_4"%> <!--#include virtual="/includes/Plantilla_Personalizacion_Rotulacion_4_cons_en.asp"-->
	...
	case "es" 'para poner los literales en CASTELLANO
			...
			select case lcase(nombre) 'cada pagina carga su fichero de constantes
				...
				<%case "lista_articulos_gag_empleados_gls"%> <!--#include virtual="/includes/Lista_Articulos_Gag_Empleados_GLS_cons_es.asp"-->
				...
				<%case "plantilla_personalizacion_rotulacion"%> <!--#include virtual="/includes/Plantilla_Personalizacion_Rotulacion_cons_es.asp"-->
				<%case "plantilla_personalizacion_rotulacion_3"%> <!--#include virtual="/includes/Plantilla_Personalizacion_Rotulacion_3_cons_es.asp"-->
				<%case "plantilla_personalizacion_rotulacion_4"%> <!--#include virtual="/includes/Plantilla_Personalizacion_Rotulacion_4_cons_es.asp"-->
