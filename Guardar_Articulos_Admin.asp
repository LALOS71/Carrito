...
<%
		...
		if accion="MODIFICAR" then 'aqui modificamos articulos
					...
					if Request.Form("cmbhoja_ruta")<>"" then
						cadena_ejecucion=cadena_ejecucion & " , REQUIERE_HOJA_RUTA = '" & Request.Form("cmbhoja_ruta") & "'"
					  else
					  	cadena_ejecucion=cadena_ejecucion & " , REQUIERE_HOJA_RUTA = NULL"
					end if
					...
					if Request.Form("txtvalor_rappel")<>"" then
						cadena_ejecucion=cadena_ejecucion & " , VALOR_RAPPEL = REPLACE('" & Request.Form("txtvalor_rappel") & "', ',', '.')"
					  else
					  	cadena_ejecucion=cadena_ejecucion & " , VALOR_RAPPEL = NULL"
					end if
					...
					if Request.Form("txtpeso")<>"" then
						cadena_ejecucion=cadena_ejecucion & " , PESO = REPLACE('" & Request.Form("txtpeso") & "', ',', '.')"
					  else
					  	cadena_ejecucion=cadena_ejecucion & " , PESO = NULL"
					end if
					if Request.Form("cmbdevolucion")<>"" then
						cadena_ejecucion=cadena_ejecucion & " , PERMITE_DEVOLUCION = '" & Request.Form("cmbdevolucion") & "'"
					  else
					  	cadena_ejecucion=cadena_ejecucion & " , PERMITE_DEVOLUCION = NULL"
					end if
					
					if Request.Form("cmben_avoris_solo_ver")<>"" then
						cadena_ejecucion=cadena_ejecucion & " , EN_AVORIS_SOLO_VER = '" & Request.Form("cmben_avoris_solo_ver") & "'"
					  else
					  	cadena_ejecucion=cadena_ejecucion & " , EN_AVORIS_SOLO_VER = NULL"
					end if
					
					if Request.Form("txtcodigo_arancelario")<>"" then
						cadena_ejecucion=cadena_ejecucion & " , CODIGO_ARANCELARIO = '" & Request.Form("txtcodigo_arancelario") & "'"
					  else
					  	cadena_ejecucion=cadena_ejecucion & " , CODIGO_ARANCELARIO = NULL"
					end if
				...
				if accion="ALTA" then
					...
					cadena_campos=cadena_campos & " MOSTRAR, REQUIERE_HOJA_RUTA, FACTURABLE, BORRADO, REQUIERE_AUTORIZACION,"
					cadena_campos=cadena_campos & " RAPPEL, VALOR_RAPPEL, PRECIO_COSTE, PROVEEDOR, REFERENCIA_DEL_PROVEEDOR, PESO, PERMITE_DEVOLUCION"  
					cadena_campos=cadena_campos & " , EN_AVORIS_SOLO_VER, CODIGO_ARANCELARIO"  
					...
					if Request.Form("cmbhoja_ruta")<>"" then
						cadena_valores=cadena_valores & ", '" & Request.Form("cmbhoja_ruta") & "'"
					  else
					  	cadena_valores=cadena_valores & ", NULL"
					end if
					if Request.Form("cmbfacturable")<>"" then
					...
					if Request.Form("txtvalor_rappel")<>"" then
						cadena_valores=cadena_valores & ", REPLACE('" & Request.Form("txtvalor_rappel") & "', ',', '.')"
					  else
					  	cadena_valores=cadena_valores & ", NULL"
					end if
					if Request.Form("txtprecio_coste")<>"" then
					...
					if Request.Form("txtpeso")<>"" then
						cadena_valores=cadena_valores & ", REPLACE('" & Request.Form("txtpeso") & "', ',', '.')"
					  else
					  	cadena_valores=cadena_valores & ", NULL"
					end if
					if Request.Form("cmbdevolucion")<>"" then
						cadena_valores=cadena_valores & ", '" & Request.Form("cmbdevolucion") & "'"
					  else
					  	cadena_valores=cadena_valores & ", NULL"
					end if
					
					if Request.Form("cmben_avoris_solo_ver")<>"" then
						cadena_valores=cadena_valores & ", '" & Request.Form("cmben_avoris_solo_ver") & "'"
					  else
					  	cadena_valores=cadena_valores & ", NULL"
					end if
					
					if Request.Form("txtcodigo_arancelario")<>"" then
						cadena_valores=cadena_valores & ", '" & Request.Form("txtcodigo_arancelario") & "'"
					  else
					  	cadena_valores=cadena_valores & ", NULL"
					end if
