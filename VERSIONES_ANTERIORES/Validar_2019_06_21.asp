		...
		//para atesa y gls mostramos el mensaje de cerrado el 24 y 31 de diciembre
			...
			if (empresa==4)  
				...
				if ((empresa==10)||(empresa==20))	
					{
					if (usuario!='6235' && usuario!='6239' && usuario!='6255' && usuario!='6277' && usuario!='6287' && usuario!='6326' && usuario!='6332' && usuario!='6350' && usuario!='6352' && usuario!='5873' && usuario!='5508' && usuario!='5586' && usuario!='5598' && usuario!='5422' && usuario!='5438' && usuario!='5139' && usuario!='5163' && usuario!='6059' && usuario!='6113' && usuario!='6121' && usuario!='6128' && usuario!='5942')
						{
						//location.href=ruta_redireccion
						document.getElementById('ocultoruta').value=ruta_redireccion
