...
function moverse(sino, administrador_central, carpeta, empresa, mostrar_aviso_popup, usuario)	{
	...
	if (sino=='SI')
		...
		if (empresa==4)  
			...
			//$("#pantalla_popup_gls_horario_cargo").modal("show");  	
			$("#pantalla_popup_gls_villalar").modal("show");  	
			/*
...
<div class="modal fade" id="pantalla_popup_gls_villalar" data-keyboard="false" data-backdrop="static">	
    <div class="modal-dialog modal-md" style="width:850px;">	  
      <div class="modal-content">	    
        <div class="container-fluid">
			<div class="col-md-12" align="center">
				<img class="img-responsive" src="popup/GLS_Villalar_r.jpg" border="0">
			</div>
		</div>	
...
$('#pantalla_popup_gls_villalar').on('hidden.bs.modal', function (e) {
  $("#pantalla_popup_gls_horario_cargo").modal("show");  
})

$('#pantalla_popup_gls_horario_cargo').on('hidden.bs.modal', function (e) {
  location.href=document.getElementById('ocultoruta').value	//para que se dirija a la pagina despues de cerrar el popup
})
