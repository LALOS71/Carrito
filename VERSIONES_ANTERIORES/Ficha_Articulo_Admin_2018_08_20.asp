...
<%
	...
	set empresas=Server.CreateObject("ADODB.Recordset")
		...
		with articulos
			...
			.Source= .Source & " ARTICULOS.PACKING, ARTICULOS.FACTURABLE, ARTICULOS.MATERIAL, ARTICULOS.RAPPEL, "
				...
				<div class="comment_text"> 
					...
					<table width="95%" cellspacing="6" cellpadding="0" class="logintable" align="center">
						...
						<tr>
							<td width="50%" class="dottedBorder vt al">
								...
								<tr>
									...
									<td width="83%" >
										<input class="txtfield" size="95" name="txtmaterial" id="txtmaterial" value="<%=campo_material%>"/>
									</td>
									<td width="4%"></td>
								</tr>							
								</table>
								...
								<tr>
									...
									<td width="83%" >
                                      <textarea class="txtfield" rows="4" cols="80" name="txtacabado" id="txtacabado"><%=campo_acabado%></textarea>
								...
								<table cellpadding="2" cellspacing="1" border="0" width="100%">
                                  <tr>
                                    ...
                                    <td width="12%"><select  name="cmbautorizacion" id="cmbautorizacion">
                                        <option value="NO" selected>NO</option>
										<option value="SI">SI</option>
									...
									<td width="8%">Rappel: </td>
                                    <td width="59%">
										<select  name="cmbrappel" id="cmbrappel">
                                        	<option value="NO" selected>NO</option>
											<option value="SI">SI</option>
                                      	</select>
						...
						<tr>
							<!--6.08 - Translate titles and buttons-->
							<td class="al">
								<span class='fontbold'>Coste y Proveedor</span>
							</td>
						</tr>
						<tr>
							<td width="50%" class="dottedBorder vt al">
							  <table cellpadding="2" cellspacing="1" border="0" width="100%">
								<tr>
									<td width="13%">Precio Coste: </td>
									<td width="9%" >
                                      <input class="txtfield" size="5" maxlength="10" name="txtprecio_coste" id="txtprecio_coste" value="<%=campo_precio_coste%>"/>
									</td>
									<td width="10%">Proveedor: </td>
                                    <td width="42%">
										<select  name="cmbproveedores" id="cmbproveedores">
											<option value="" selected="selected">* Seleccione *</option>
									...
									<td width="11%" title="Referencia del Proveedor">Ref. Prov.: </td>
									<td width="15%" >
                                      <input class="txtfield" size="10" maxlength="30" name="txtreferencia_del_proveedor" id="txtreferencia_del_proveedor" value="<%=campo_referencia_del_proveedor%>"/>
									</td>
								</tr>							
