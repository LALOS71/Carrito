...
<%
		...
		cantidad_superior=Request.Form("cantidad_superior")
		...
		if cantidad_superior="" then
			cantidad_superior="NULL"
		end if
		...
		if accion="ALTA" then
			cadena_campos="CODIGO_ARTICULO, CANTIDAD, PRECIO_UNIDAD, PRECIO_PACK, TIPO_SUCURSAL, CODIGO_EMPRESA, CANTIDAD_SUPERIOR"
			cadena_valores=codigo_articulo & ", " & cantidad & ", " & precio_unidad & ", " & precio_pack
			cadena_valores=cadena_valores & ", '" & tipo_sucursal & "', " & codigo_empresa & ", " & cantidad_superior
		...
		if accion="MODIFICACION" then
			...
			cadena_ejecucion=cadena_ejecucion & ", CANTIDAD_SUPERIOR=" & cantidad_superior
