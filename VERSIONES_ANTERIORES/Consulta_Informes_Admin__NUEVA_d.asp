		...
		with consumos
			...
			if agrupacion_seleccionada="empresa" then
				...
				if diferenciar_articulos_seleccionada="SI" then
					.Source= .Source & ", ARTICULOS.CODIGO_SAP, ARTICULOS.DESCRIPCION, ARTICULOS.UNIDADES_DE_PEDIDO"
				end if
				...
				.Source= .Source & " group by ARTICULOS.CODIGO_SAP, ARTICULOS.DESCRIPCION, ARTICULOS.UNIDADES_DE_PEDIDO"
				if diferenciar_sucursales_seleccionada="SI" then
					'.Source= .Source & ", V_CLIENTES.NOMBRE, V_CLIENTES.CODIGO_EXTERNO"
					.Source= .Source & ",V_CLIENTES.Id,V_CLIENTES.NOMBRE, V_CLIENTES.CODIGO_EXTERNO"
				end if
			...
			if articulos_sin_consumo_seleccionada="SI" then
				...
				cadena_articulos=cadena_articulos & " ARTICULOS.DESCRIPCION, ARTICULOS.UNIDADES_DE_PEDIDO"
				if diferenciar_tipo_seleccionada="SI" then
				...
				if diferenciar_articulos_seleccionada="SI" then
					cadena_envios=cadena_envios & ", ARTICULOS.CODIGO_SAP, ARTICULOS.DESCRIPCION, ARTICULOS.UNIDADES_DE_PEDIDO"
				end if
				if diferenciar_marca_seleccionada="SI" then
					cadena_envios=cadena_envios & ", V_CLIENTES.MARCA"
				end if
			...
			response.write("<br><BR>CADENA_ENVIOS: " & cadena_envios)
			response.write("<br><BR>CADENA_TOTAL: " & consulta_total)
			response.write("<BR><br><BR>CONSULTA ANTIGUA: " & .source)			
...
<tr>
	...
	<td width="713" valign="top">
		<div id="main">
				...
				<div class="comment_title fontbold">INFORMES</div>
				<div class="comment_text"> 
					<form name="frmbuscar_consumos" id="frmbuscar_consumos" method="post" action="Consulta_Informes_Admin__NUEVA.asp">
					...
					<table width="95%" cellspacing="6" cellpadding="0" class="logintable" align="center">
						...
						<tr>
							<td width="50%" class="dottedBorder vt al">
								...
								<tr>
									<td width="14%">Agrupar Por: </td>
									<td width="15%">
										<input type="radio" id="optagrupacion_empresa" name="optagrupacion" value="empresa" checked /> Empresa
									</td>
									<td width="71%">
										<input type="radio" id="optagrupacion_articulo" name="optagrupacion" value="articulo" /> Art&iacute;culo
									</td>
									<%if agrupacion_seleccionada<>"" then%>
										<script language="javascript">
					...
					<table><tr><td height="5"></td></tr></table>		
					<table width="95%" cellspacing="6" cellpadding="0" align="center" style="background-color:#B09F87">
