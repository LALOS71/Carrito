...
function moverse(sino, administrador_central, carpeta, empresa, mostrar_aviso_popup, usuario)	{
	...
	if ((empresa==2)||(empresa==10)||(empresa==20)||(empresa==30)||(empresa==40)||(empresa==50)||(empresa==80)||(empresa==90)||
				(empresa==100)||(empresa==110)||(empresa==130)||(empresa==170)||(empresa==210)||(empresa==220)||(empresa==230))	{
	    cadena_carpeta='GAG/'
	    cadena_empresa='_Gag'			
	}		
	...
	if (sino=='SI')
		...
		if (empresa==4)  
			...
			$("#pantalla_popup_fiesta_local_salamanca").modal("show");
...
<div class="modal fade" id="pantalla_popup_fiesta_local_salamanca" data-keyboard="false" data-backdrop="static">	
    <div class="modal-dialog modal-md" style="width:850px;">	  
      <div class="modal-content">	    
        <div class="container-fluid">
			<div class="col-md-12" align="center">
				<img class="img-responsive" src="popup/Festividad_Local_8_Sep_r.jpg" border="0">
			</div>
		</div>	
...
$('#pantalla_popup_fiesta_local_salamanca').on('hidden.bs.modal', function (e) {
  	//para que se redirija a cada popup correspondiente segun la empresa
	redirigir('<%=empresa_entrada%>')
})

redirigir=function(empresa){
	//console.log('entramos en redirigir: ' + empresa)
	switch(empresa) {
		case '4':
				$("#pantalla_popup_devoluciones").modal("show");
				break;
