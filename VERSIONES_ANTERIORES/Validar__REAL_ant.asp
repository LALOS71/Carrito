...
function moverse(sino, administrador_central, carpeta, empresa, mostrar_aviso_popup, usuario)	{
	...
	if (sino=='SI')
		...
		if (empresa==4)  
			...
			$("#pantalla_popup_puente_constitucion").modal("show");  	
...
<div class="modal fade" id="pantalla_popup_puente_constitucion" data-keyboard="false" data-backdrop="static">	
    <div class="modal-dialog modal-md">	  
      <div class="modal-content">	    
        <div class="container-fluid">
			<div class="col-md-12" align="center">
				<img class="img-responsive" src="popup/PUENTE_CONSTITUCION_r.jpg" border="0">
			</div>
		</div>	
...
$('#pantalla_popup_puente_constitucion').on('hidden.bs.modal', function (e) {
