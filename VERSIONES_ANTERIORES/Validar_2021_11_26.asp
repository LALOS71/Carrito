...
'****************************************************************************
	...
	if empresa_query="GLOBALIA" then
		hotel_seleccionado=6646 'GSC - ADMON UNIFORMIDAD
		contrasenna_seleccionada="GSC_UNI"
		empresa_entrada=110
	end if
      ...
      <div class="modal-content">	    
        ...
        <div class="modal-footer">  
				<div class="text-right">
					<button type="button" class="btn btn-primary" id="cmdmanual_devoluciones">Ver Manual</button>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
