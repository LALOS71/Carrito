						...
						<tr>
							<td width="50%" class="dottedBorder vt al">
								...
								<tr>
									...
									<td width="15%">
										<input type="radio" id="optagrupacion_empresa" name="optagrupacion" value="empresa" onclick="mostrar_capas('articulos')" checked /> Empresa
									</td>
									<td width="71%">
										<input type="radio" id="optagrupacion_articulo" name="optagrupacion" value="articulo" onclick="mostrar_capas('empresas')"/> Art&iacute;culo
									</td>
									<%if agrupacion_seleccionada<>"" then%>
										<script language="javascript">
