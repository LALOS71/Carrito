...
<%
	...
	emails_reciben="malba@halconviajes.com"
			...
			if estado_pedido("ESTADO")="ENVIADO" or estado_pedido("ESTADO")="LISTO" THEN
				if estado_pedido("ESTADO")="ENVIADO" then
					...
					with si_hay_enviados_parciales
						...
						.Source=cadena_ejecucion
						'response.write("<br>-5a- se ve los detalle de pedido enviados: " & .source)
						.Open
					end with
				...
				if estado_pedido("ESTADO")="LISTO" then
					...
					with si_hay_listos_parciales
						...
						cadena_ejecucion="SELECT * FROM PEDIDOS_DETALLES"
						cadena_ejecucion=cadena_ejecucion & " WHERE ID_PEDIDO=" & pedido_seleccionado
						cadena_ejecucion=cadena_ejecucion & " AND ESTADO<>'LISTO'"
						.Source=cadena_ejecucion
						'response.write("<br>-5b- se ve los detalle de pedido LISTO: " & .source)
						.Open
					end with
				...
				with si_hay_enviados_parciales
					...
					.Source=cadena_ejecucion
					'response.write("<br>-5C- se ve los detalle de pedido enviados: " & .source)
					.Open
				end with
				...
				with si_hay_listos_parciales
					...
					.Source=cadena_ejecucion
					'response.write("<br>-5D- se ve los detalle de pedido LISTO: " & .source)
					.Open
				end with
...
<BODY onload="validar('<%=creamos_albaran%>','<%=albaran_nuevo%>')">
	...
	'conn.execute sql
%>
<!-- ya no lo uso, vuelve a la ficha del pedido
