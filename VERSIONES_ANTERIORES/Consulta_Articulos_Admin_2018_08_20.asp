...
function mostrar_articulo(articulo,accion)
   {
	...
	if (document.getElementById('cmbempresas').value=='')
		...
		document.getElementById('ocultoempresas').value='Sin Filtro'
	  	...
	  	{
		document.getElementById('ocultoempresas').value=document.getElementById('cmbempresas').options[document.getElementById('cmbempresas').selectedIndex].text
		}

	if (document.getElementById('cmbfamilias').value=='')
		{
		document.getElementById('ocultofamilias').value='Sin Filtro'
		}
	  else
	  	{
		document.getElementById('ocultofamilias').value=document.getElementById('cmbfamilias').options[document.getElementById('cmbfamilias').selectedIndex].text
		}
		
	if (document.getElementById('cmbautorizacion').value=='')
		{
		document.getElementById('ocultoautorizacion').value='Sin Filtro'
		}
	  else
	  	{
		document.getElementById('ocultoautorizacion').value=document.getElementById('cmbautorizacion').value
		}
		
	if (accion=='EXCEL')
		{
		document.getElementById('frmmostrar_articulo').action='Stocks_Articulos_Excel.asp'	
		}
	  else
	  	{
...
<font size="2" color="#000000"><%=mitabla_articulos(CAMPO_CODIGO_SAP_ARTICULO,i)%></font>																<BR />
																<%
		  ...
		  <div class="submit_btn_container">	
					...
					<table width="68%" border="0" cellpadding="0" cellspacing="0" align="center" class="info_column">
						<tr>
							<td width="47%">
							...
							<td width="21%">&nbsp;</td>
							<td width="32%">
								<input class="submitbtn" type="submit" name="informe_excel" id="informe_excel" value="Exportar a Excel" onclick="mostrar_articulo(0,'EXCEL');return false" />
							</td>
