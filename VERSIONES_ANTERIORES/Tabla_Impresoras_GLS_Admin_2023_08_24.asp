...
<%
	...
	if sesion_caducada= "NO" then
		...
		while not rs_impresoras.eof
			...
			if ver_estado="BAJA APROBADA" OR ver_estado="EN REVISION" then
				...
				response.write("<button class='btn btn-primary btn-sm' onclick=""realizar_accion('" & impresora & "', '" & accion_imp & "')""")
