						...
						<td>	                                                       						
							<table border="0" cellpadding="1" cellspacing="1" width="102%" class="info_table" align="center">
								<tr style="background-color:#FCFCFC" valign="top">
									...
									<th class="menuhdr" width="75">Fecha</th>
									<th class="menuhdr" width="61">Importe</th>
									<th class="menuhdr" width="79">Estado</th>
								...
								<%vueltas=1
									...
									<tr  style="cursor:hand;cursor:pointer;" valign="top" onmouseover="javascript:this.style.background='#ffc9a5';" onmouseout="javascript:this.style.background='#FCFCFC'">
										...
										<td  onclick="mostrar_pedido(<%=pedidos("id")%>,<%=pedidos("Nreg")%>);return false" class="item_row" style="background-color:<%=color_fila%>;text-align:left" width="75" ><%=pedidos("fecha")%></td>                                            
                                        <td  onclick="mostrar_pedido(<%=pedidos("id")%>,<%=pedidos("Nreg")%>);return false" 
                                            class="item_row" style="background-color:<%=color_fila%>;text-align:left" width="61" >                                        
                                            <%																											
										...
										<td  onclick="mostrar_pedido(<%=pedidos("id")%>,<%=pedidos("Nreg")%>);return false" width="79" class="ac item_row" style="background-color:<%=color_fila%>;"><%=pedidos("estado")%></td>
