	...
	set empresas=Server.CreateObject("ADODB.Recordset")
		...
		with consumos
			...
			if agrupacion_seleccionada="empresa" then
				...
				.Source= .Source & ", ARTICULOS.UNIDADES_DE_PEDIDO, ARTICULOS.RAPPEL, ARTICULOS.VALOR_RAPPEL"
				.Source= .Source & ", ARTICULOS.PRECIO_COSTE, (SELECT DESCRIPCION FROM PROVEEDORES WHERE ID=ARTICULOS.PROVEEDOR) AS PROVEEDOR"
				.Source= .Source & ", ARTICULOS.REFERENCIA_DEL_PROVEEDOR"
				...
				.Source= .Source & " group by ARTICULOS.CODIGO_SAP, ARTICULOS.DESCRIPCION, ARTICULOS.UNIDADES_DE_PEDIDO, ARTICULOS.RAPPEL, ARTICULOS.VALOR_RAPPEL"
				.Source= .Source & ", ARTICULOS.PRECIO_COSTE, ARTICULOS.PROVEEDOR, ARTICULOS.REFERENCIA_DEL_PROVEEDOR"
				if diferenciar_empresas_seleccionada="SI" then
					'.Source= .Source & ", V_CLIENTES.NOMBRE, V_CLIENTES.CODIGO_EXTERNO"
