	...
	if (sino=='SI')	{	
		...
		*/
			...
			if (empresa==4)  
				...
				//document.getElementById('ocultoruta').value=ruta_redireccion	
				document.getElementById('ocultoruta').value=ruta_redireccion	
				$("#pantalla_popup_asm_gestor_cuenta").modal("show");  	
				}
			  else
				{
...
<div class="modal fade" id="pantalla_popup_asm_gestor_cuenta" data-keyboard="false" data-backdrop="static">	
    <div class="modal-dialog modal-md">	  
      <div class="modal-content">	    
        <div class="container-fluid">
			<div class="col-md-12" align="center">
...
$('#pantalla_popup_asm_gestor_cuenta').on('hidden.bs.modal', function (e) {
