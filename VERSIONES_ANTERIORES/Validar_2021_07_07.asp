...
<div class="modal fade" id="pantalla_popup_semana_santa_2021" data-keyboard="false" data-backdrop="static">	
    <div class="modal-dialog modal-md" style="width:850px;">	  
      <div class="modal-content">	    
        <div class="container-fluid">
			<div class="col-md-12" align="center">
				<img class="img-responsive" src="popup/GLS_Semana_Santa_2021_r.jpg" border="0">
			</div>
		</div>	
...
$('#pantalla_popup_semana_santa_2021').on('hidden.bs.modal', function (e) {
