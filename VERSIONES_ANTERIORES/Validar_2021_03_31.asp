	...
	if (sino=='SI')
		...
		if (empresa==4)  
			...
			if ((('<%=session("usuario_tipo")%>'=='AGENCIA') && ('<%=session("usuario_pais")%>'=='ESPAÑA')) || (('<%=session("usuario_tipo")%>'=='ARRASTRES') && ('<%=session("usuario_pais")%>'=='ESPAÑA')))
				{
				$("#pantalla_popup_problemas_pasarela").modal("show");  	
				}
			  else
				{
				location.href=document.getElementById('ocultoruta').value
...
<div class="modal fade" id="pantalla_popup_problemas_pasarela" data-keyboard="false" data-backdrop="static">	
    <div class="modal-dialog modal-md" style="width:850px;">	  
      <div class="modal-content">	    
        <div class="container-fluid">
			<div class="col-md-12" align="center">
				<img class="img-responsive" src="popup/GLS_Problemas_Pasarela_Pago_r.jpg" border="0">
			</div>
		</div>	
...
$('#pantalla_popup_problemas_pasarela').on('hidden.bs.modal', function (e) {
