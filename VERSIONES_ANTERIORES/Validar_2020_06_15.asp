...
'****************************************************************************
	...
	if empresa_query="HALCON" and tipo_query="PROPIA" then
		...
		hotel_seleccionado=5315 '657 HALCON propia - LAS PALMAS - GENERAL VIVES
		contrasenna_seleccionada="HALCON_657"
		
		hotel_seleccionado=6214 '001 HALCON propia - CANALEJAS
		contrasenna_seleccionada="HALCON_001"
		
		'hotel_seleccionado=6215 '002 HALCON propia - CACERES
		'contrasenna_seleccionada="HALCON_002"
		
		'hotel_seleccionado=6218 '006 HALCON propia - HOSPITALET
		'contrasenna_seleccionada="HALCON_006"
	...
	if empresa_query="ECUADOR" and tipo_query="PROPIA" then
		...
		hotel_seleccionado=599 'ECUADOR propia
...
function moverse(sino, administrador_central, carpeta, empresa, mostrar_aviso_popup, usuario)	{
	...
	if (sino=='SI')
		...
		if (empresa==4)  
			...
			$("#pantalla_popup_gls_fiesta_12_junio").modal("show");  	
			/*
...
<div class="modal fade" id="pantalla_popup_gls_fiesta_12_junio" data-keyboard="false" data-backdrop="static">	
    <div class="modal-dialog modal-md">	  
      <div class="modal-content">	    
        <div class="container-fluid">
			<div class="col-md-12" align="center">
				<img class="img-responsive" src="popup/GLS_Fiesta_12_Junio_r.jpg" border="0">
			</div>
		</div>	
        <div class="modal-footer">                  
          <p><button type="button" class="btn btn-default" data-dismiss="modal"><%=validar_ventana_mensajes_boton_cerrar%></button></p>                
...
$('#pantalla_popup_gls_fiesta_12_junio').on('hidden.bs.modal', function (e) {
  $("#pantalla_popup_gls_articulos_personalizables").modal("show");
})
