	...
	*/
	...
	if (sino=='SI')
		...
		if (empresa==4)  
			...
			$("#pantalla_popup_fiesta_salamanca").modal("show");	
...
<div class="modal fade" id="pantalla_popup_fiesta_salamanca" data-keyboard="false" data-backdrop="static">	
    <div class="modal-dialog modal-md" style="width:850px;">	  
      <div class="modal-content">	    
        <div class="container-fluid">
			<div class="col-md-12" align="center">
				<img class="img-responsive" src="popup/Festividad_Local_2022_09_08_r.jpg" border="0">
			</div>
		</div>	
...
$('#pantalla_popup_fiesta_salamanca').on('hidden.bs.modal', function (e) {
