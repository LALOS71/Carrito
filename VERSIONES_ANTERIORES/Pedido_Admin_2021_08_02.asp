					...
					<div class="card-body">
						<div class="row">
							...
							<div class="input-group mb-3 col-3">
								...
								<div class="input-group-append" id="boton_cambiar_todos_los_combos" style="display:none">
							...
							if  pedidos("DESTINATARIO")<>"" then%>
								<div class="card col-6">
									<div class="card-body">
											...
											Destinarario: <strong><%=ucase(pedidos("DESTINATARIO"))%></strong>
			...
			<div class="row mt-2"> <!--detalle del pedido-->
				<div class="card col-12">
					<div class="card-body">
						...
						<div class="row" id="tabla_leyendas">
							<div class="col-3">
						...
						<div>
								...
								<div class="row mt-2">
									<div class="col-2">Pedido Numero: <strong><%=pedido_seleccionado%></strong></div>
								...
								<table id="lista_pedidos" name="lista_pedidos" class="table table-striped table-bordered" cellspacing="0" width="100%">
									<thead>
										<tr>
											...
											<th>Estado</th>
											<th>Hoja Ruta</th>
											<th style="text-align:center"><i class="fas fa-paperclip"></i></th>
											<th>Alb.</th>
											<th title="Fecha del Envio Programado">Envio Prog.</th>
										</tr>
									</thead>
									<%if pedidos.eof then%>
										<tr> 
									...
									<tr style="background-color:#FCFCFC" valign="top">
										...
										<td class="cantidades" id="fila_pedido_<%=fila%>_cantidad" style="text-align:right;font-size:2;color:#000000"><%=pedidos("cantidad")%></td>
										...
										<td id="fila_pedido_<%=fila%>_estado">
											...
											<%
												...
												IF not envios_parciales.eof then%>
															<table class="table table-sm"  border="0" cellspacing="0" cellpadding="0" id="tabla_envios_parciales_<%=pedidos("articulo")%>" style="display:none"  bgcolor="#FFFFFF">
										...
										<td id="fila_pedido_<%=fila%>_hoja_ruta" style="text-align:right">
											<input class="form-control form-control-sm hoja_de_ruta" size="10" type="text" name="txthoja_ruta_<%=pedidos("articulo")%>" id="txthoja_ruta_<%=pedidos("articulo")%>" value="" />
											<script language="javascript">
												document.getElementById("txthoja_ruta_<%=pedidos("articulo")%>").value='<%=pedidos("hoja_ruta")%>'
											</script>
										</td>
										<td id="fila_pedido_<%=fila%>_fichero_personalizacion" >
											<%
										...
										<td class="albaranes" id="fila_pedido_<%=fila%>_albaran" style="text-align:right;font-size:1;color:#000000">
										...
										<td id="fila_pedido_<%=fila%>_envio_programado" style="text-align:right"><font size="1" color="#000000">
									...
									if not devoluciones.eof then
										...
										wend%>
										<tr>
											<th style="text-align:right" colspan="4"><font color="#880000">Total Descontando Devoluciones </font></th>
											<th style="text-align:right"><font color="#880000"><%=FORMATNUMBER((total_pedido - descuento_total_devoluciones),2,-1,0,-1)%> €</font></th>
									...
									<%end if%>
										...
										<%if tipo_pedido_auto="PRIMER_PEDIDO_REDYSER" then%>
											...
											<tr>
												<th style="text-align:right" colspan="4"><font color="#880000">Total Precio Final</font></th>
												<th style="text-align:right"><font color="#880000">
													<%
						...
						<!-- botonera-->		
						<div class="row mt-2 cuadro_informacion_adicional">	
							...
							<div class="col-4">
								<button type="button" class="btn btn-primary btn-block" id="cmdimprimir" name="cmdimprimir"
									 onclick="javascript:imprSelec('contenido_imprimible');
																...
																ventimp.document.write('link.href = \'plugins/bootstrap-4.0.0/css/bootstrap.min.css\';');
																...
																ventimp.document.write('var elementos = document.getElementsByClassName(\'cuadro_informacion_adicional\');');
																ventimp.document.write('for(var i = 0; i < elementos.length; i++)');
																ventimp.document.write('{elementos[i].style.display = \'none\';}');
																ventimp.document.write('</script>');
																ventimp.document.write('<script type=\'text/javascript\' src=\'plugins/bootstrap-4.0.0/js/bootstrap.min.js\'></script>');
...
function guardar_pedido(cadena_articulos_cantidades, accion){
    ...
    for (i=0;i<tabla_articulos_cantidades.length;i++)    {
	    ...
	    */
		...
		if ((accion=='GUARDAR') && ((document.getElementById('cmbestados_' + articulo_cantidad[0]).value=='ENVIADO') || (document.getElementById('cmbestados_' + articulo_cantidad[0]).value=='ENVIO PARCIAL')) )
			{
