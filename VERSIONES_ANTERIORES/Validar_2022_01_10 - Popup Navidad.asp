...
'****************************************************************************
	...
	if empresa_query="FECUADOR" then
		hotel_seleccionado=9926 'C23 ECUADOR propia
		contrasenna_seleccionada="ECUADOR.C23"
		empresa_entrada=250
	end if
...
function moverse(sino, administrador_central, carpeta, empresa, mostrar_aviso_popup, usuario)	{
	...
	if (sino=='SI')
		...
		if (empresa==4)  
			...
			//a propias y fanquicias se les saca el aviso de cambio de modelo de impresora termica
      ...
      <div class="modal-content">	    
        <div class="container-fluid">
			<div class="col-md-12" align="center">
				<img class="img-responsive" src="popup/Aviso_Navidades_2021_r.jpg" border="0">
				<br />
			</div>
		</div>	
...
<div class="modal fade" id="pantalla_popup_devoluciones" data-keyboard="false" data-backdrop="static">	
    <div class="modal-dialog modal-md" style="width:850px;">	  
      <div class="modal-content">	    
        <div class="container-fluid">
			<div class="col-md-12" align="center" style="margin-top:5px ">
				<img class="img-responsive" src="popup/GLS_Devoluciones_r.jpg" border="0">
				
			</div>
		</div>	
        <div class="modal-footer">  
				<div class="text-right">
					<button type="button" class="btn btn-primary corporativo_gls" id="cmdmanual_devoluciones">Ver Manual</button>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
				</div>
        </div>  
...
$('#pantalla_popup_aviso_navidad').on('hidden.bs.modal', function (e) {
  moverse('<%=valido%>','<%=administrador_central%>','<%=session("usuario_carpeta")%>',<%=empresa_entrada%>, '<%=mostrar_aviso_popup%>',  '<%=hotel_seleccionado%>')
})
...
$("#cmdmanual_devoluciones" ).on( "click", function() {
	cadena_enlace=''
	if ('<%=session("usuario_tipo")%>'=='ARRASTRES')
		{
		cadena_enlace='Agencias.pdf'
		}
	...
	if ('<%=session("usuario_tipo")%>'=='GLS PROPIA')
		{
		cadena_enlace='Propias.pdf'
		}
  window.open('popup/Devoluciones_GLS/Devoluciones_' + cadena_enlace)
});

$('#pantalla_popup_devoluciones').on('hidden.bs.modal', function (e) {
	/*
	if (('<%=session("usuario_tipo")%>'=='ARRASTRES'))
		{
		location.href=document.getElementById('ocultoruta').value
