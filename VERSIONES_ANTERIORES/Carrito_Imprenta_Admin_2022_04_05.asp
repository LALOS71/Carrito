	...
	<td width="713">
		<div id="main">
				...
				<div class="comment_text"> 
					<form name="frmpedido" id="frmpedido" action="Grabar_Pedido_Imprenta_Admin.asp" method="post"  enctype="multipart/form-data">
                        ...
                        <tr valign="top">
                          ...
                          <td class="item_row" style="text-align:right; background-color:<%=colorcin%>" width="67" valign="middle">
                              ...
                              <tr>
                                ...
                                <td style="background-color:<%=colorcin%>" class="item_row"><a href="Carrito_Imprenta_Admin.asp?borrar=<%=id%>&acciones=<%=cadena_acciones%>" class="fontbold">Quitar</a></td>
                              </tr>
                          </table></td>
                        </tr>
						<%if accion="MODIFICAR" then%>
							...
							<td width="17%">
								...
								<table border="0" cellpadding="0" cellspacing="0" width="100%" class="btn-details">
									<tr>
										...
										<td width="74%"><a href="Lista_Articulos_Imprenta_Admin_Pedir.asp?acciones=<%=cadena_acciones%>"><font color="#FFFFFF">Continuar</font></a></td>
									</tr>
								</table>
