			...
			<div class="contentcell">
				<div class="sidefreetext" ><div align="left">
					...
					<table width="95%" border="0" cellpadding="0" cellspacing="0" align="center" class="info_column">
						<tr>
							<td width="50%">
								<a href="Carrito_Imprenta_Admin.asp?acciones=<%=acciones%>" class="btn-details"><font color="#FFFFFF">Ver Pedido</font></a>
							</td>
							<td width="50%">
			...
			<table width="90%" cellspacing="6" cellpadding="0" class="logintable" align="center">
				...
				<tr>
					<td width="50%" class="dottedBorder vt al">
						...
						<form name="frmbusqueda" id="frmbusqueda" method="post" action="Lista_Articulos_Imprenta_Admin_Pedir.asp?acciones=<%=acciones%>">
...
<form name="frmannadir_al_carrito" id="frmannadir_al_carrito" action="Annadir_Articulo_Imprenta_Admin.asp?acciones=<%=acciones%>" method="post">
