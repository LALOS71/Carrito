...
'Next
	...
	if origen="LOGIN" then
		...
		sql=sql & " FROM [192.168.156.175\SERVERSQL].GAG.dbo.CLIENTES"
	...
	if origen="MODIFICAR" then
		...
		if valido="CONTRASENNA_CORRECTA" then
			...
			Next
			cadena_ejecucion="UPDATE [192.168.156.175\SERVERSQL].GAG.dbo.CLIENTES SET CONTRASENA='" & contrasenna_nueva_seleccionada &"'"
