...
<div class="wrapper">
        ...
        <div id="content">
			...
			<div class="container-fluid">
                <h3 align="center">Informe de Referencias Con Stock M&iacute;nimo</h3>
				<div class="row form-check">
					<input class="form-check-input" type="checkbox" value="" id="chksolicitados">
					<label class="form-check-label" for="chksolicitados">Mostrar Los Art&iacute;culos ya Solicitados al Proveedor</label>
				</div>
				<div class="row">
...
j$("#chksolicitados").click(function(){
...
consultar_refs = function() {  
      var err ="";
		...
		*/
       	prm.add("p_solicitados", j$("#chksolicitados").prop('checked'));
