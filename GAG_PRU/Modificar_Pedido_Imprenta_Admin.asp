...
<BODY onload="validar('<%=mensaje_aviso%>', '<%=accion%>')">
	...
	'conn.execute sql
%>
<form name="frmconfirmar_pedido" id="frmconfirmar_pedido" method="post" action="Consulta_Pedidos_Admin.asp">
</form>

<form action="Rellenar_Variables_Sesion_Imprenta_Admin.asp" method="post" name="frmmodificar_pedido" id="frmmodificar_pedido">
