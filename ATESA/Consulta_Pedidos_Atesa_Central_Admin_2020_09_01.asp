							...
							<table border="0" cellpadding="1" cellspacing="1" width="100%" class="info_table" align="center">
								...
								<%while not pedidos.eof%>
											...
											<tr style="background-color:#FCFCFC;cursor:hand;cursor:pointer" valign="top" onmouseover="javascript:this.style.background='#ffc9a5';" onmouseout="javascript:this.style.background='#FCFCFC'">
												<td width="185" class="ac item_row" onclick="mostrar_detalle(<%=pedidos("id")%>);"><%=pedidos("NOMBRE")%>
												...
												<td width="177" class="ac item_row"  valign="middle">
													<%if pedidos("estado")="PENDIENTE AUTORIZACION" then%>
														<table width="90%" border="0" cellpadding="0" cellspacing="0">
																<tr>
																	<td width="10%"><img src="../images/Confirmar.png" border="0" height="16" width="16" /></td>
																	<td width="18%"><a href="#" onclick="modificar_pedido(<%=pedidos("id")%>, 'CONFIRMAR')" class="fontbold">Confirmar</a></td>
																	<td width="34%">&nbsp;</td>
																	<td width="11%"><img src="../images/icono_modificar.png" border="0" height="16" width="16" /></td>
																	<td width="27%"><a href="#" onclick="modificar_pedido(<%=pedidos("id")%>, 'MODIFICAR')" class="fontbold">Modificar</a></td>
																</tr>
														</table>
													<%end if%>
