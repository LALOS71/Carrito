...
<%
	...
	if session("usuario")="" then
		...
		if accion="MODIFICAR" then 'aqui modificamos pedidos
				...
				cadena_valores=hotel_admin & ", '" & DATE() & "', 'PENDIENTE AUTORIZACION'"
...
<BODY onload="validar('<%=mensaje_aviso%>')">
	...
	'conn.execute sql
%>
<form name="frmgrabar_pedido" id="frmgrabar_pedido" method="post" action="Consulta_Pedidos_Atesa_Central_Admin.asp">
</form>
</BODY>
   <%	
   		'regis.close			
