...
<%
		...
		'response.write("<br>" & sql)
			...
			with articulos
				...
				.Source=.Source & " V_EMPRESAS.CARPETA, V_CLIENTES.MARCA, V_CLIENTES.Id as ID_CLIENTE, ARTICULOS_PERSONALIZADOS.PLANTILLA_PERSONALIZACION"
						...
						<td width="839">
							<div id="main">
										...
										<table border="0" cellpadding="1" cellspacing="1" width="100%" class="info_table">
											...
											<tr style="background-color:#FCFCFC" valign="top">
												<td class="ac item_row" width="76" align="right">
												...
												<td class="item_row" style="text-align:left" width="252">
													<%=articulos("DESCRIPCION")%>
													<%if articulos("plantilla_personalizacion")<>"" then%>
														<i class="fab fa-wpforms" style="color:#00CC00;cursor:pointer" title="Plantilla Asociada"
												...
												<td width="58" class="item_row" style="text-align:right"><%=articulos("cantidad")%>&nbsp;</td>
												
												<td class="ac item_row" width="134"><%=articulos("estado")%></td>
																			<td class="ac item_row" width="23">
													<%
