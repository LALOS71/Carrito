...
<%
		...
		with tipo_oficina
			...
			.Source="SELECT V_CLIENTES.TIPO_PRECIO FROM PEDIDOS INNER JOIN V_CLIENTES ON PEDIDOS.CODCLI = V_CLIENTES.Id "
		...
		sql=sql & " and (id in (select codigo_articulo from cantidades_precios "
			...
			<div class="contentcell">
				<div class="sidefreetext" ><div align="left">
					...
					<table width="95%" border="0" cellpadding="0" cellspacing="0" align="center" class="info_column">
						<tr>
							<td width="50%">
								<a href="Carrito_Atesa_Central_Admin.asp?acciones=<%=acciones%>" class="btn-details"><font color="#FFFFFF">Ver Pedido</font></a>
							</td>
							<td width="50%">
			...
			<table width="90%" cellspacing="6" cellpadding="0" class="logintable" align="center">
				...
				<tr>
					<td width="50%" class="dottedBorder vt al">
						...
						<form name="frmbusqueda" id="frmbusqueda" method="post" action="Lista_Articulos_Atesa_Central_Admin_Pedir.asp?acciones=<%=acciones%>">
...
<form name="frmannadir_al_carrito" id="frmannadir_al_carrito" action="Annadir_Articulo_Atesa_Central_Admin.asp?acciones=<%=acciones%>" method="post">
